...
DESCRIPTION:
	...
	$Id: msnetManager.asm,v 1.1 97/04/10 11:55:25 newdeal Exp $
...
include msnetConstant.def

;------------------------------------------------------------------------------
;				Variables
;------------------------------------------------------------------------------

include msnetStrings.asm
include	msnetVariable.def

;------------------------------------------------------------------------------
;				Code
;------------------------------------------------------------------------------

include	msnetEntry.asm	; strategy & administrative gradoo
include	msnetDisk.asm		; DR_FS_DISK* implementation
include msnetInitExit.asm	; Initialization/exit routines.
include msnetSecondary.asm	; Support routines for primary to call
include msnetUtils.asm	; Random utility things.
include msnetHooks.asm
