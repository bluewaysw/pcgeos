...
DESCRIPTION:
	...
	$Id: msnetSecondary.asm,v 1.1 97/04/10 11:55:25 newdeal Exp $
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%@
MSNetGetExtAttribute proc	far
		.enter
		mov	ax, ERROR_ATTR_NOT_SUPPORTED
		stc
		.leave
		ret
MSNetGetExtAttribute endp



COMMENT @%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
		MSNetSetExtAttribute
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%@
MSNetSetExtAttribute proc	far
		.enter
		mov	ax, ERROR_ATTR_CANNOT_BE_SET
		stc
		.leave
		ret
MSNetSetExtAttribute endp
