...
ROUTINES:
	Name			Description
	----			-----------
    GLB BCLFIStrategy		Strategy routine
...
DefFIFunction	BCLFIOpen,		DR_FIDOI_OPEN
DefFIFunction	BCLFIClose,		DR_FIDOI_CLOSE
DefFIFunction	BCLFIGetHeader,		DR_FIDOI_GET_HEADER
DefFIFunction	BCLFIGetPage,		DR_FIDOI_GET_PAGE
DefFIFunction	BCLFIGetComplexData,	DR_FIDOI_GET_COMPLEX_DATA
