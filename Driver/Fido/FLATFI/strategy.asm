...
ROUTINES:
	Name			Description
	----			-----------
    GLB FFIStrategy		Strategy routine
...
FFIStrategy	proc	far
	...
	ret
badCall:
EC <		ERROR	FLAT_FIDO_INPUT_INVALID_DRIVER_FUNCTION		>
NEC <		stc							>
NEC <		jmp	done						>
...
DefFIFunction	FFIOpen,		DR_FIDOI_OPEN
DefFIFunction	FFIClose,		DR_FIDOI_CLOSE
DefFIFunction	FFIGetHeader,		DR_FIDOI_GET_HEADER
DefFIFunction	FFIGetPage,		DR_FIDOI_GET_PAGE
DefFIFunction	FFIGetComplexData,	DR_FIDOI_GET_COMPLEX_DATA
