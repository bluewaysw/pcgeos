...
vidTestRoutines	label	nptr
                nptr    offset VidTestVGA24             ; VD_VESA_640x480_24
                nptr    offset VidTestSVGA24            ; VD_VESA_640x480_24
                nptr    offset VidTestUVGA24            ; VD_VESA_640x480_24
                nptr    offset VidTestHVGA24            ; VD_VESA_1280x1K_24

	; this table holds the offsets to the test routines for the devices
vidSetRoutines	label	nptr
                nptr    offset VidSetVESA               ; VD_VESA_640x480_24
                nptr    offset VidSetVESA               ; VD_VESA_640x480_24
                nptr    offset VidSetVESA               ; VD_VESA_640x480_24
                nptr    offset VidSetVESA               ; VD_VESA_1280x1K_24
