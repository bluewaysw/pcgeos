...
DESCRIPTION:
	Tables particular to 8 bit drivers
		
	$Id: vga8Tables.asm,v 1.1 97/04/18 11:42:02 newdeal Exp $
...
vidTestRoutines	label	nptr
		nptr	offset VidTestVGA8		; VD_VESA_640x480_8
		nptr	offset VidTestSVGA8		; VD_VESA_800x600_8
ifndef PRODUCT_WIN_DEMO
		nptr	offset VidTestUVGA8		; VD_VESA_1Kx768_8
		nptr	offset VidTestHVGA8		; VD_VESA_1280x1K_8
		nptr	offset VidTestTVGA8		; VD_VESA_640x400_8_TV
endif

	; this table holds the offsets to the test routines for the devices
vidSetRoutines	label	nptr
		nptr	offset VidSetVESA		; VD_VESA_640x480_8
		nptr	offset VidSetVESA		; VD_VESA_800x600_8
ifndef PRODUCT_WIN_DEMO
		nptr	offset VidSetVESA		; VD_VESA_1Kx768_8
		nptr	offset VidSetVESA		; VD_VESA_1280x1K_8
		nptr	offset VidSetVESA		; VD_VESA_640x400_8_TV
endif
