...
DESCRIPTION:
	...
	$Id: vga8GenChar.asm,v 1.2 96/08/05 03:51:51 canavese Exp $
...
DrawCharByte    proc    near
                ...
                mov     bx,word ptr cs:[tempDither][bp]  
                mov     cx,word ptr cs:[tempDither+2][bp]
                mov     si,word ptr cs:[tempDither+4][bp]
                mov     bp,word ptr cs:[tempDither+6][bp]
