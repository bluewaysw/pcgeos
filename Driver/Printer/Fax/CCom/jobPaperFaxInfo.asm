...
DESCRIPTION:
	...
	$Id: jobPaperFaxInfo.asm,v 1.1 97/04/18 11:52:39 newdeal Exp $
...
SYNOPSIS:	Set the paper path

CALLED BY:	DR_PRINT_SET_PAPER_PATH

PASS:		al - PaperInputOptions
		ah - PaperOutputOption
...
PrintSetPaperPath	proc	far
	...
	.enter
	mov	ds, bp
CheckHack	<offset PS_paperOutput eq offset PS_paperInput +1>
CheckHack	<size PS_paperOutput eq 1>

	mov	{word} ds:[PS_paperInput], ax
	clc
	.leave
	ret
