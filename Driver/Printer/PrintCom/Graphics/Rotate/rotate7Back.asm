...
DESCRIPTION:
	...
	$Id: rotate7Back.asm,v 1.1 97/04/18 11:51:10 newdeal Exp $
...
SYNOPSIS:	
	special rotate routine for Oki 9-pin dogs.
...
PSEUDO CODE/STRATEGY:
	differs from the normal rotate7lines routine in that the top bit
	is the LSB.
...
groupLoop:
	...
	mov	count,7		;do 7 bits in one byte.
byteloop:
	push	si
	...
	shr	ax,1		;do the last bit zero rotate.
	shr	bx,1
	shr	cx,1
	shr	dx,1
