...
DESCRIPTION:
	...
	uses teh 4 byte high method fro toshiba printers.

APPLICATION:
	Toshiba 24 pin printers 2 pass hi res mode 360 x 180 dpi
		Tosh24.geo

	$Id: rotate2pass24Into4.asm,v 1.1 97/04/18 11:51:12 newdeal Exp $
...
SYNOPSIS:	Print a high density row
		...
		HI_RES_BUFF_HEIGHT must be the height of the printhead
		or less.
                If HI_RES_BUFF_HEIGHT is less than 24, the routine will
                rotate into the top HI_RES_BUFF_HEIGHT lines of a 24 pin
