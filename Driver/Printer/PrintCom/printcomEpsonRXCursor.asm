...
FILE:		printcomEpsonRXCursor.asm
...
DESCRIPTION:
	This file contains most of the code to implement the epson RX type
	print driver cursor movement support

	The cursor position is kept in 2 words: integer 216ths in Y and
	integer 72nds in X

	$Id: printcomEpsonRXCursor.asm,v 1.1 97/04/18 11:50:11 newdeal Exp $
