...
FILE:		printcomDeskjetCMYGraphics.asm
...
DESCRIPTION:
	...
	$Id: printcomDeskjetCMYGraphics.asm,v 1.1 97/04/18 11:50:12 newdeal Exp $

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%@

include	Graphics/graphicsCommon.asm		;common graphic print routines
include Graphics/graphicsPrintSwathPCLCMY.asm	;PrintSwath routine.
