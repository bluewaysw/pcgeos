...
DESCRIPTION:
	...
	+tractor and manual feed print driver UI support for HP quietjet

	$Id: uiEvalQuietjet.asm,v 1.1 97/04/18 11:50:38 newdeal Exp $
...
PrintEvalASF0Bin	proc	near
	...
	push	si
	mov	si,offset OptionsASF0BinResource:ASF0BinSymbolList
	call	PrintEvalASFCommon
	pop	si
