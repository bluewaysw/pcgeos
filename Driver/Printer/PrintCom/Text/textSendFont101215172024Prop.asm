...
FILE:		textSendFont101215172024Prop.asm
...
DC_ESCRIPTION:
	...
	$Id: textSendFont101215172024Prop.asm,v 1.1 97/04/18 11:49:57 newdeal Exp $
...
PrintSendFont	proc	near
		...
		je	sendTheFont
		mov	si, offset cs:pr_codes_Set17Pitch ; check the next one
		cmp	es:[PS_curFont].FE_fontID, FID_PRINTER_17CPI ; chk ass
		je	sendTheFont
		mov	si, offset cs:pr_codes_Set20Pitch ; assume it's 20CPI
		...
		mov	si, offset cs:pr_codes_Set24Pitch ; assume it's 20CPI
