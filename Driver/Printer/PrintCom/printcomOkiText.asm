...
DESCRIPTION:
	This file contains most of the code to implement common Okidata 9 pin
	print driver ascii text support

	$Id: printcomOkiText.asm,v 1.1 97/04/18 11:50:51 newdeal Exp $
...
include	Text/Font/fontOkiInfo.asm
