...
#
#	$Id: epson9.gp,v 1.1 97/04/18 11:53:16 newdeal Exp $
#
##############################################################################
#
...
resource fx286eInfo	data, shared, read-only, conforming
resource fx85Info	data, shared, read-only, conforming
resource fx86eInfo	data, shared, read-only, conforming
resource dfx5000Info	data, shared, read-only, conforming
resource m1809Info	data, shared, read-only, conforming
