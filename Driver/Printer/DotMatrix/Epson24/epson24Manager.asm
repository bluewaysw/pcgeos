...
DESCRIPTION:
	...
	$Id: epson24Manager.asm,v 1.1 97/04/18 11:53:28 newdeal Exp $
...
include	epson24lq500Info.asm		; specific info for LQ-500 printer
include	epson24lq800Info.asm		; specific info for LQ-800 printer
include	epson24lq900Info.asm		; specific info for LQ-950 printer
include	epson24lq1000Info.asm		; specific info for LQ-1000 printer
include	epson24lq1500Info.asm		; specific info for LQ-1500 printer
include	epson24lq2500Info.asm		; specific info for LQ-2500 printer
include	epson24generInfo.asm		; specific info for generic printer
include	epson24generwInfo.asm		; specific info for gen. wide printer
