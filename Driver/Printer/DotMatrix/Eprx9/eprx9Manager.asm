...
DESCRIPTION:
	...
	$Id: eprx9Manager.asm,v 1.1 97/04/18 11:53:50 newdeal Exp $
...
include printcomEpsonRXText.asm        ; common code to implement text routines
...
include printcomEpsonRXCursor.asm ; Epson RX 9-pin cursor routines

include eprx9Dialog.asm ; code to implement UI setting
include eprx9ControlCodes.asm	; Tables of printer commands
...
include	eprx9DriverInfo.asm		; overall driver info

include	eprx9rx80Info.asm		; specific info for RX-80 printer
include	eprx9rx100Info.asm		; specific info for RX-100 printer
