...
DESCRIPTION:
	This file contains the device information for the ppds generw printer

	Other Printers Supported by this resource:

	$Id: ppds24generwInfo.asm,v 1.1 97/04/18 11:54:26 newdeal Exp $
