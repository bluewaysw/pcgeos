...
PROJECT:	PC GEOS
MODULE:		IBM PPDS 24-pin printer driver for Zoomer
FILE:		ppds24zDriverInfo.asm
...
DESCRIPTION:
	...
	$Id: ppds24zDriverInfo.asm,v 1.1 97/04/18 11:54:25 newdeal Exp $
...
DefPrinter PD_IBM_2390, "IBM 2390", generInfo
DefPrinter PD_IBM_2391, "IBM 2391", generwInfo
