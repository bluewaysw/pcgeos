...
DESCRIPTION:
	...
	$Id: epson48jManager.asm,v 1.1 97/04/18 11:54:51 newdeal Exp $
...
include	epson48jDriverInfo.asm		; overall driver info
...
;include	epson48sq870Info.asm

include		epson48stylus800Info.asm
