...
DESCRIPTION:
	...
	$Id: epson48Manager.asm,v 1.1 97/04/18 11:54:54 newdeal Exp $
...
include	epson48sq870Info.asm		; specific info for SQ-870 printer
include	epson48sq1170Info.asm		; specific info for SQ-1170 printer
...
include	epson48stylus800Info.asm	; specific info for Stylus 800 printer
