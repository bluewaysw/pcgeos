...
DESCRIPTION:
	...
	$Id: epson48zDriverInfo.asm,v 1.1 97/04/18 11:54:41 newdeal Exp $
...
DefPrinter PD_CANON_BJC800, "Canon BJC-800 (Color)", bjc800Info
DefPrinter PD_CANON_BJC800_MONO, "Canon BJC-800 (B/W)", bjc800MInfo
