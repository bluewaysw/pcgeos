...
PROJECT:	PC GEOS
MODULE:		Blue Chip 9-pin Print Driver
FILE:		bchip9ControlCodes.asm
...
DC_ESCRIPTION:
	This file contains all the Printer Control Codes for the bchip 9-pin
	driver.
		
	$Id: bchip9ControlCodes.asm,v 1.1 97/04/18 11:53:36 newdeal Exp $

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%@

;*****************************************************************************
;
;CONTROL CODES FOR THE Blue Chip 9-PIN PRINTERS.....
;
