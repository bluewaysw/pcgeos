...
PROJECT:	PC GEOS
MODULE:		Blue Chip 9-pin driver
FILE:		bchip9generwInfo.asm
...
DESCRIPTION:
	This file contains the device information for the Blue Chip generic
		wide carriage printer

	Other Printers Supported by this resource:

	$Id: bchip9generwInfo.asm,v 1.1 97/04/18 11:53:37 newdeal Exp $
