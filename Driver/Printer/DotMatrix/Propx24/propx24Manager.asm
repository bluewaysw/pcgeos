...
DESCRIPTION:
	...
	$Id: propx24Manager.asm,v 1.1 97/04/18 11:53:48 newdeal Exp $
...
include	propx24DriverInfo.asm		; overall driver info
...
include	propx24pp24pInfo.asm		; specific info for Proprinter 24P 
