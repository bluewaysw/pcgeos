...
DESCRIPTION:
	...
	$Id: canon48Manager.asm,v 1.1 97/04/18 11:54:05 newdeal Exp $
...
include	canon48DriverInfo.asm		; overall driver info

include	canon48generInfo.asm		; specific info for gen. printer
include	canon48generwInfo.asm		; specific info for gen. wide printer
include	canon48bj10eInfo.asm		; specific info for bj10e printer
include	canon48execjetInfo.asm		; specific info for execjet printer
