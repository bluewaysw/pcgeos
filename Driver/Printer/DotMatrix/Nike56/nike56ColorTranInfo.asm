...
DESCRIPTION:
	...
	$Id: nike56ColorTranInfo.asm,v 1.1 97/04/18 11:55:46 newdeal Exp $
...
colorTranInfo	segment	resource
...
PrinterInfo		<	< PT_RASTER,	; ---- PrinterType ------------
				...
				NULL,
						; ---- Mode Info Offsets ------
				offset colorTranLoRes,
				offset colorTranMedRes,
				offset colorTranHiRes,
				NULL,
				NULL,
						; ---- Font Geometry ----------
				NULL,
...
colorTranHiRes	GraphicsProperties < HI_RES_COLOR_X_RES,	; xres
				     ...
				     handle nikeTranInkCorrection > ; colorcorr

colorTranMedRes	GraphicsProperties < MED_RES_COLOR_X_RES,	; xres
...
colorTranLoRes	GraphicsProperties < LO_RES_COLOR_X_RES,	; xres
