...
DESCRIPTION:
	...
	narrow carriage printer using transparencies.

	Other Printers Supported by this resource:

	$Id: nike56BaseTranInfo.asm,v 1.1 97/04/18 11:55:44 newdeal Exp $
...
PrinterInfo		   <  < PT_RASTER,    ; ---- PrinterType -------------
				...
				NULL,		
                                        ; ---- Mode Info Offsets -------
                                offset baseTranLoRes,
                                offset baseTranMedRes,
                                offset baseTranHiRes,
                                NULL,
                                NULL,
                                        ; ---- Font Geometry -----------
                                NULL,
...
baseTranHiRes	GraphicsProperties < HI_RES_MONO_X_RES,		; xres
				     ...
				     handle gamma20 >		; color correct

baseTranMedRes	GraphicsProperties < MED_RES_MONO_X_RES,	; xres
...
baseTranLoRes	GraphicsProperties < LO_RES_MONO_X_RES,		; xres
