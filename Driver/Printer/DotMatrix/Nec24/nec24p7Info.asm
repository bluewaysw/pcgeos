...
DESCRIPTION:
	...
	$Id: nec24p7Info.asm,v 1.1 97/04/18 11:54:19 newdeal Exp $
...
p7lowRes	GraphicsProperties < LO_RES_X_RES,	; xres
				     LO_RES_Y_RES,	; yres
...
p7medRes	GraphicsProperties < MED_RES_X_RES,	; xres
				     MED_RES_Y_RES,	; yres
...
p7hiRes		GraphicsProperties < HI_RES_X_RES,	; xres
				     HI_RES_Y_RES,	; yres
...
p7fontGeometries     FontGeometry \
                <       FID_DTC_URW_ROMAN,
                        12,
                        offset p7_12ptpitchTab >
                word    FID_INVALID             ;table terminator


p7_12ptpitchTab      label   byte
        byte    TP_20_PITCH
        byte    TP_17_PITCH
        byte    TP_15_PITCH
        byte    TP_12_PITCH
