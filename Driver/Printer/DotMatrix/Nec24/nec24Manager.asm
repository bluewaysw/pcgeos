...
DESCRIPTION:
	...
	$Id: nec24Manager.asm,v 1.1 97/04/18 11:54:18 newdeal Exp $
...
include	nec24DriverInfo.asm		; overall driver info

include	nec24p2200Info.asm		; specific info for P2200 printer
include	nec24p3300Info.asm		; specific info for P3300 printer
