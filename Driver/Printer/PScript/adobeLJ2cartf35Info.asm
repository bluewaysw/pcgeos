...
DESCRIPTION:
	...
	$Id: adobeLJ2cartf35Info.asm,v 1.1 97/04/18 11:56:19 newdeal Exp $

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%@

;----------------------------------------------------------------------------
;	Adobe LaserJet 2 Cartridge
;----------------------------------------------------------------------------

adobeLJ2f35Info	segment	resource
	...
	; info blocks
		...
		PrinterInfo <		; ---- PrinterType -------------
				...
				NULL,
				NULL,
			        offset adobeLJ2f35hiRes, ; PM_GRAPHICS_HI_RES
				NULL,	
				NULL,
                                        ; ---- Font Geometry -----------
                                NULL,
...
adobeLJ2f35hiRes   GraphicsProperties < 300,		; xres
					300,		; yres
					1,  		; band height
					1, 		; bytes/column.
					1,		; interleaves
...
;	*must* be placed directly after the hires GraphicProperties struct
		...
		PSInfoStruct   <
			      ...
			      ALJ2_PROLOG_LEN,	; prolog length
			      offset adobeLJ2f35Prolog ; ptr to prolog
...
adobeLJ2f35Prolog	label	byte
	...
	char	"end", NL
adobeLJ2f35EndProlog	label	byte

ALJ2_PROLOG_LEN equ	offset adobeLJ2f35EndProlog - offset adobeLJ2f35Prolog

adobeLJ2f35Info	ends
