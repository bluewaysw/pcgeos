...
DESCRIPTION:
	...
	$Id: pscriptgenerCf35Info.asm,v 1.1 97/04/18 11:56:22 newdeal Exp $
...
generCf35Info	segment	resource
...
generCf35Res	   GraphicsProperties < 300,		; xres
					300,		; yres
					1,  		; band height
					1,  		; buff height
					1, 		; interleaves
...
;	*must* be placed directly after the hires GraphicProperties struct
		...
		PSInfoStruct   <
			      ...
			      GENERICC_PROLOG_LEN,	; prolog length
			      offset generCf35Prolog ; ptr to prolog
...
generCf35Prolog	label	byte
	...
	char	"end", NL
generCf35EndProlog	label	byte

GENERICC_PROLOG_LEN equ	offset generCf35EndProlog - offset generCf35Prolog
