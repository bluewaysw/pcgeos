...
DESCRIPTION:
	...
	$Id: mercuryManager.asm,v 1.1 97/04/18 11:52:30 newdeal Exp $
...
include printcomDeskjetKCMYGraphics.asm ; common Color deskjet graphics routines

include mercuryControlCodes.asm  ; Tables of printer commands
...
include	mercuryDriverInfo.asm		; overall driver info

include	mercuryInfo.asm
include Color/Correct/correctDJ550C.asm    ; color correction table
