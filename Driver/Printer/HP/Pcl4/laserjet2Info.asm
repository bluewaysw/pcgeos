...
DESCRIPTION:
	...
	$Id: laserjet2Info.asm,v 1.1 97/04/18 11:52:19 newdeal Exp $
...
laserjet2Info	segment	resource
...
PrinterInfo		 <		; ---- PrinterType -------------
				...
				NULL,		
					; ---- Mode Info Offsets -------
				offset laserjet2lowRes,
				offset laserjet2medRes,
				offset laserjet2hiRes,
				NULL,	
				offset laserjet2nlq,
                                        ; ---- Font Geometry -----------
                                laserjet2FontGeometry,
                                        ; ---- Symbol Set list -----------
                                offset laserjet2SymbolSets,
					; ---- PaperMargins ------------
...
laserjet2lowRes  GraphicsProperties < LO_RES_X_RES,      ; xres
                                     LO_RES_Y_RES,      ; yres
...
laserjet2medRes  GraphicsProperties < MED_RES_X_RES,     ; xres
                                     MED_RES_Y_RES,     ; yres
...
laserjet2hiRes   GraphicsProperties < HI_RES_X_RES,      ; xres
                                     HI_RES_Y_RES,      ; yres
...
laserjet2nlq	label	word
		nptr	laserjet2_10CPI
		word	0			; table terminator

laserjet2SymbolSets label   word
...
laserjet2_10CPI	label	word

laserjet2FontGeometry	DownloadProperties	< HP_II_MAX_SOFT_FONTS,
						HP_II_MAX_POINTSIZE >
