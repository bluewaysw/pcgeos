...
;-------------------------
	...
	mov	sp,cs:[bsisrSP]
        ...
        uses    ax, bx,cx, dx, ds, si, es, si, bp  ; LA 11.09.98
        .enter

        call    SysEnterInterrupt	; LA 10.09.98
        ...
        call	BSECTest		; for error checking
...
new_wave:
        ...
        jmp	short yes_rec
;
; not NewWave or Recording --> old Play
;
no_nw:
	call	BSDACISR			; Play
...
; Speicher fuer Stack
;---------------------
oldSS	word	0			; gespeichertes Stacksegment
...
Funktion:       create Stackspace for ISR
