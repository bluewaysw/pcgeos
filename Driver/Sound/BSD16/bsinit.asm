...
REVISION HISTORY:
        ...
        DL	18.03.2000	functions implemented
...
irqctrl2:
        ...
        call	WaitPerJump			; wait some microseconds
...
markWithNull:
	...
	je	readDMA
        ...
        cmp     al, C_CAP_H     ; => DMA Channel 16 bit
	je	readDMA_H
	cmp	al, C_SMALL_H
	je	readDMA_H
