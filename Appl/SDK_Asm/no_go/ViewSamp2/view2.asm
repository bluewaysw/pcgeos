...
DESCRIPTION:
	This file contains a application that shows an example of a flexibly
	sized content in a non-scrollable GenView.

	$Id: view2.asm,v 1.1 97/04/04 16:35:02 newdeal Exp $
...
view2_ProcessClass	class GenProcessClass
			
view2_ProcessClass	endc
			
			
			
idata	segment
	view2_ProcessClass	mask CLASSF_NEVER_SAVED
...
METHOD:		ViewOriginChanged -- 
		MSG_ORIGIN_CHANGED for view2_ProcessClass
...
ViewOriginChanged	method view2_ProcessClass, \
...
ViewCreated	method view2_ProcessClass,
	...
	;
	; Set the bounds of the document based on the view size (in cx, dx)
	;
...
METHOD:		ViewStartSelect -- 
		MSG_META_START_SELECT for view2_ProcessClass
...
ViewStartSelect	method view2_ProcessClass, MSG_META_START_SELECT
...
METHOD:		ViewViewClosing -- 
		MSG_META_CONTENT_VIEW_CLOSING for view2_ProcessClass
...
ViewViewClosing	method view2_ProcessClass, \
...
FUNCTION:	ViewExposedWin -- MSG_META_EXPOSED for view2_ProcessClass
...
ViewExposedWin	method	view2_ProcessClass, \
					MSG_META_EXPOSED
	; Updating the window...
