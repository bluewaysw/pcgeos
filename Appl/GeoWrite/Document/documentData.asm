...
DESCRIPTION:
	...
	$Id: documentData.asm,v 1.1 97/04/04 15:56:57 newdeal Exp $
...
;
; The various versions of GeoWrite expect the various element arrays to be
...
_SA_0 label byte
	...
	US_DEFAULT_DOCUMENT_LEFT_MARGIN, ;SAE_leftMargin -- set for U.S.
	US_DEFAULT_DOCUMENT_TOP_MARGIN, ;SAE_topMargin -- set for U.S.
	US_DEFAULT_DOCUMENT_RIGHT_MARGIN, ;SAE_rightMargin -- set for U.S.
	US_DEFAULT_DOCUMENT_BOTTOM_MARGIN, ;SAE_bottomMargin -- set for U.S.
	<>,			;SAE_masterPages
	0,			;SAE_charsDeleted
	0,			;SAE_linesDeleted
...
GOUIL_base	label	byte
	...
	ElementArrayHeader 	<<5,0,0,size ElementArrayHeader>,
				EA_FREE_LIST_TERMINATOR>
	; Offset to element
