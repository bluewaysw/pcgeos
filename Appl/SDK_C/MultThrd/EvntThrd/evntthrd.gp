...
#
# PROJECT:      GEOS
# MODULE:       Event Thread (Sample GEOS application)
# FILE:         evntthrd.gp
#
# AUTHOR:       EB 1/96
#
...
#
# RCS STAMP:
#       $Id: evntthrd.gp,v 1.1 97/04/04 16:40:57 newdeal Exp $
#
##############################################################################
#
...
# handled by the MTProcessClass, which is defined in multthrd.goc.
#
class   ETProcessClass
#
# Specify application object. This is the object that serves as the top-level
# UI object in the application. See multthrd.goc.
#
appobj  ETApp
#
...
#
export SecondaryProcessClass
export ETTriggerClass
