...
#
#	$Id: dictionary.gp,v 1.1 97/04/04 16:40:10 newdeal Exp $
#
##############################################################################
#
...
#
# Specify stack size: We need a stack size somewhat larger than the default.
#
stack	2500
#
...
# handled by the DictionaryProcessClass, which is defined in dictionary.goc.
#
class	DictionaryProcessClass
#
# Specify application object. This is the object that serves as the top-level
# UI object in the application. See dictionary.goc.
#
appobj	DictionaryApp
#
...
#
export DictionaryManagerClass
export SpellCheckManagerClass
