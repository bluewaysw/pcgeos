...
#
# PROJECT:	PC/GEOS
# MODULE:	ExclMsg (Sample PC/GEOS application)
# FILE:		exclmsg.gp
#
# AUTHOR:	Eric E. Del Sesto, 11/90
#
# DESCRIPTION:	This file contains Geode definitions for the "ExclMsg" sample
#		application. This file is read by the GLUE linker to
#		build this application.
#
# RCS STAMP:
#	$Id: exclmsg.gp,v 1.1 97/04/04 16:38:17 newdeal Exp $
#
##############################################################################
#
...
# process will be handled by the ExclMsgProcessClass, which is defined
# in exclmsg.asm.
#
class	ExclMsgProcessClass
#
