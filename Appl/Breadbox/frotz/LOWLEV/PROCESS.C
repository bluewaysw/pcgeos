...
#ifdef __GEOS__
        ((pcfm_OpcodePrototype) ProcCallFixedOrMovable_cdecl)( var_opcodes[opcode & 0x1f] );
#else
...
#ifdef __GEOS__
        ((pcfm_OpcodePrototype) ProcCallFixedOrMovable_cdecl)( op1_opcodes[opcode & 0x0f] );
#else
...
#ifdef __GEOS__
        ((pcfm_OpcodePrototype) ProcCallFixedOrMovable_cdecl)( op0_opcodes[opcode - 0xb0] );
#else
...
#ifdef __GEOS__
        ((pcfm_OpcodePrototype) ProcCallFixedOrMovable_cdecl)( var_opcodes[opcode - 0xc0] );
#else
...
static void __extended__ (void)
{
    ...
    {
#ifdef __GEOS__
        ((pcfm_OpcodePrototype) ProcCallFixedOrMovable_cdecl)( ext_opcodes[opcode] );
#else
