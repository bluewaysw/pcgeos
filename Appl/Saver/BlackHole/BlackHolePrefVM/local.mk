# $Id: local.mk,v 1.1 97/04/04 16:44:18 newdeal Exp $
GSUFF		= vm
#
...
#
LINKFLAGS	+= -i $(ROOT_DIR)/Installed/Appl/Preferences/PrefMgr/prefmgr.geo -N "BlackHole" -t "VMPD" -l "BlackHole Options"
#
