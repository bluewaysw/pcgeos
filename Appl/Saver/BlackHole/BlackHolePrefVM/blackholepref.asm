...
DESCRIPTION:
	Saver-specific preferences for BlackHole saver.
		

	$Id: blackholepref.asm,v 1.1 97/04/04 16:44:19 newdeal Exp $
...
;
; Include constants from BlackHole, the saver, for use in our objects.
;
