...
DESCRIPTION:
	Saver-specific preferences for Hopalong driver.
		

	$Id: hopalongpref.asm,v 1.1 97/04/04 16:45:00 newdeal Exp $
...
;
; Include constants from Hopalong, the saver, for use in our objects.
;
