...
DESCRIPTION:
	Saver-specific preferences for Noodle driver.
		

	$Id: noodlepref.asm,v 1.1 97/04/04 16:46:10 newdeal Exp $
...
;
; Include constants from Noodle, the saver, for use in our objects.
;
include ../noodle.def
