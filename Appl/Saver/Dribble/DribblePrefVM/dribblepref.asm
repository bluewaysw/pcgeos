...
DESCRIPTION:
	Saver-specific preferences for Dribble driver.
		

	$Id: dribblepref.asm,v 1.1 97/04/04 16:43:57 newdeal Exp $
...
;
; Include constants from Dribble, the saver, for use in our objects.
;
include ../dribble.def
