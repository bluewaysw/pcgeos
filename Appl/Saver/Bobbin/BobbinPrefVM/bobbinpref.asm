...
DESCRIPTION:
	Saver-specific preferences for Bobbin driver.
		

	$Id: bobbinpref.asm,v 1.1 97/04/04 16:43:38 newdeal Exp $
...
;
; Include constants from Bobbin, the saver, for use in our objects.
;
include ../bobbin.def
