...
DESCRIPTION:
	Saver-specific preferences for Ticker Tape
		

	$Id: tickertapepref.asm,v 1.1 97/04/04 16:47:40 newdeal Exp $
...
; Now the object tree.
; 
include	tickertapepref.rdef

idata	segment

idata	ends

TickertapePrefCode	segment resource


COMMENT @%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
		TickertapePrefGetPrefUITree
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%@
TickertapePrefGetPrefUITree	proc far
	mov	dx, handle RootObject
	mov	ax, offset RootObject
	ret
TickertapePrefGetPrefUITree	endp

global TickertapePrefGetPrefUITree:far


COMMENT @%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
		TickertapePrefGetModuleInfo
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%@
TickertapePrefGetModuleInfo	proc far
	.enter
	...
	.leave
	ret
TickertapePrefGetModuleInfo	endp

global TickertapePrefGetModuleInfo:far


TickertapePrefCode	ends
