...
#
# PROJECT:	PC/GEOS
# MODULE:	FreeCell (Sample PC/GEOS application)
# FILE:		freecell.gp
#
# AUTHOR:	Mark Hirayama, 7/93
#
# RCS STAMP:
#	$Id: freecell.gp,v 1.1 97/04/04 15:02:59 newdeal Exp $
#
##############################################################################
#
...
resource TableResource	ui-object

#
# Notice that the AppInterface resource runs objects under the appication
