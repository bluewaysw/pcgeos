...
#
#
# Parameters file for: pmba.geo
#
#	$Id: pmba.gp,v 1.15 95/12/06 18:25:31 lester Exp $
#
##############################################################################
#
# Permanent name
...
resource SimpleHelpResource read-only shared object
...
resource DocumentProtoProgressUI object
...
# VisKeymapClass isn't defined for PMBA, so skip its export
skip 1
