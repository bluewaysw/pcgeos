...
DESCRIPTION:
	...
	$Id: cwinClassMisc.asm,v 1.19 96/08/15 20:05:42 canavese Exp $
...
ifdef _PCV_HAS_A_WINDOW_SYSTEM_WITH_REGIONS_FOR_BOUNDS
	;
	; I haven't bothered to up date these since we don't yet
	; support blanking regions.  If this conditional is ever
	; set, these will have to be updated to the new shapes.
	;
windowRegionBW	label	Region
	; Implied Bounds (UL - LR): (PARAM_0, PARAM_1) - (PARAM_2, PARAM_3)
	word	PARAM_1-1,					EOREGREC
	word	PARAM_1,	PARAM_0+1, PARAM_2-2,		EOREGREC
	word	PARAM_1+1,	PARAM_0,   PARAM_2-1,		EOREGREC
	word	PARAM_3-2,	PARAM_0,   PARAM_2,		EOREGREC
	word	PARAM_3-1,	PARAM_0+1, PARAM_2,		EOREGREC
	word	PARAM_3,	PARAM_0+2, PARAM_2-1,		EOREGREC
	word	EOREGREC

toolDialogRegionBW label Region
	; Implied Bounds (UL - LR): (PARAM_0, PARAM_1) - (PARAM_2, PARAM_3)
	word	PARAM_1-1,					EOREGREC
	word	PARAM_1,	PARAM_0+2, PARAM_2-2,		EOREGREC
	word	PARAM_1+1,	PARAM_0+1, PARAM_2-1,		EOREGREC
	word	PARAM_3-2,	PARAM_0,   PARAM_2,		EOREGREC
	word	PARAM_3-1,	PARAM_0+1, PARAM_2-1,		EOREGREC
	word	PARAM_3,	PARAM_0+2, PARAM_2-2,		EOREGREC
	word	EOREGREC

fitNotePadRegionBW label Region
	; Implied Bounds (UL - LR): (PARAM_0, PARAM_1) - (PARAM_2, PARAM_3)
	word	PARAM_1-1,					EOREGREC
	word	PARAM_1,	PARAM_0+1, PARAM_2-6,		EOREGREC
	word	PARAM_1+1,	PARAM_0,   PARAM_2-5,		EOREGREC
	word	PARAM_1+2,	PARAM_0,   PARAM_2-4,		EOREGREC
	word	PARAM_1+3,	PARAM_0,   PARAM_2-3,		EOREGREC
	word	PARAM_1+4,	PARAM_0,   PARAM_2-2,		EOREGREC
	word	PARAM_1+5,	PARAM_0,   PARAM_2-1,		EOREGREC
	word	PARAM_3-6,	PARAM_0,   PARAM_2,		EOREGREC
	word	PARAM_3-5,	PARAM_0+1, PARAM_2,		EOREGREC
	word	PARAM_3-4,	PARAM_0+2, PARAM_2,		EOREGREC
	word	PARAM_3-3,	PARAM_0+3, PARAM_2,		EOREGREC
	word	PARAM_3-2,	PARAM_0+4, PARAM_2,		EOREGREC
	word	PARAM_3-1,	PARAM_0+5, PARAM_2,		EOREGREC
	word	PARAM_3,	PARAM_0+6, PARAM_2-1,		EOREGREC
	word	EOREGREC

fitNoteRegionBW	label	Region
	; Implied Bounds (UL - LR): (PARAM_0, PARAM_1) - (PARAM_2, PARAM_3)
	word	PARAM_1-1,					EOREGREC
	word	PARAM_1,	PARAM_0+1, PARAM_2-2,		EOREGREC
	word	PARAM_1+1,	PARAM_0,   PARAM_2-1,		EOREGREC
	word	PARAM_3-13,	PARAM_0,   PARAM_2,		EOREGREC
	word	PARAM_3-12,	PARAM_0,   PARAM_2-1,		EOREGREC
	word	PARAM_3-11,	PARAM_0,   PARAM_2-2,		EOREGREC
	word	PARAM_3-10,	PARAM_0,   PARAM_2-3,		EOREGREC
	word	PARAM_3-9,	PARAM_0,   PARAM_2-4,		EOREGREC
	word	PARAM_3-8,	PARAM_0,   PARAM_2-5,		EOREGREC
	word	PARAM_3-7,	PARAM_0,   PARAM_2-6,		EOREGREC
	word	PARAM_3-6,	PARAM_0,   PARAM_2-7,		EOREGREC
	word	PARAM_3-5,	PARAM_0,   PARAM_2-8,		EOREGREC
	word	PARAM_3-4,	PARAM_0,   PARAM_2-9,		EOREGREC
	word	PARAM_3-3,	PARAM_0,   PARAM_2-10,		EOREGREC
	word	PARAM_3-2,	PARAM_0,   PARAM_2-11,		EOREGREC
	word	PARAM_3-1,	PARAM_0+1, PARAM_2-12,		EOREGREC
	word	PARAM_3,	PARAM_0+2, PARAM_2-13,		EOREGREC
	word	EOREGREC

rolodexCardRegionBW	label	Region
	; Implied Bounds (UL - LR): (PARAM_0, PARAM_1) - (PARAM_2, PARAM_3)
	word	PARAM_1-1,					EOREGREC
	word	PARAM_1,	PARAM_0+ROLODEX_CARD_LEFT_TAB_INDENT+2,	\
				PARAM_2-ROLODEX_CARD_RIGHT_TAB_INDENT-3,\
								EOREGREC
	word	PARAM_1+ROLODEX_CARD_TAB_HEIGHT,			\
				PARAM_0+ROLODEX_CARD_LEFT_TAB_INDENT+1,	\
				PARAM_2-ROLODEX_CARD_RIGHT_TAB_INDENT-2,\
								EOREGREC
	word	PARAM_1+ROLODEX_CARD_TAB_HEIGHT+1,			\
				PARAM_0+1, PARAM_2-2,		EOREGREC
	word	PARAM_1+ROLODEX_CARD_TAB_HEIGHT+2,			\
...
blankWindowRegionBW	label Region
	; Implied Bounds (UL - LR): (PARAM_0, PARAM_1) - (PARAM_2, PARAM_3)
	word	PARAM_1-1,					EOREGREC
	word	PARAM_3,	PARAM_0, PARAM_2-1,		EOREGREC
	word	EOREGREC
else 		; else of ifdef _PCV_HAS_A_WINDOW_SYSTEM_WITH_REGIONS_FOR_BOUNDS
;
; All of these share a simple rectangular region
;
windowRegionBW	label Region
toolDialogRegionBW label Region
fitNotePadRegionBW label Region
...
blankWindowRegionBW	label Region
	...
	word	PARAM_3,	PARAM_0, PARAM_2-1,		EOREGREC
	word	EOREGREC
endif	;endif of else of ifdef _PCV_HAS_A_WINDOW_SYSTEM_WITH_REGIONS_FOR_BOUNDS
...
endif		; end of else of if _PCV

else		; else of if DRAW_SHADOWS_ON_BW_GADGETS

if _PCV
windowRegionBW	label	Region
	; Implied Bounds (UL - LR): (PARAM_0, PARAM_1) - (PARAM_2, PARAM_3)
	word	PARAM_1-1,					EOREGREC
	word	PARAM_1,	PARAM_0+1, PARAM_2-1,		EOREGREC
	word	PARAM_3-1,	PARAM_0,   PARAM_2,		EOREGREC
	word	PARAM_3,	PARAM_0+1, PARAM_2-1,		EOREGREC
	word	EOREGREC
#endif

endif		; end of else of if DRAW_SHADOWS_ON_BW_GADGETS
...
if _RUDY
	clr	cx			;just do entire window for now...
	call	VisGetBounds
	sub	cx, ax
	sub	dx, bx
	clr	ax, bx
...
tryAccelerators:
	...
	;PM: we need to check for a custom sys menu before checking the
	;    standard sys menu.
...
if _JEDIMOTIF
navigateAndSelectText:
	;
	; indicate that we should select the the text if a text object
	; is navigated to
	;
EC <	cmp	ax, MSG_GEN_NAVIGATE_TO_NEXT_FIELD			>
EC <	je	99$							>
EC <	cmp	ax, MSG_GEN_NAVIGATE_TO_PREVIOUS_FIELD			>
EC <	ERROR_NE	OL_ERROR					>
EC <99$:								>
	call	KN_DerefVisSpec_DI
	ornf	ds:[di].OLWI_moreFixedAttr, mask OWMFA_SELECT_TEXT_ON_NAVIGATE
	;fall thru
endif
...
OLWShortcutList KeyboardShortcut \
	...
	<0, 0, 0, 0, C_SYS_RIGHT and mask KS_CHAR>,	;NEXT FIELD
	<0, 0, 0, 0, C_SYS_LEFT and mask KS_CHAR>,	;PREVIOUS FIELD
	<0, 0, 0, 0, C_SYS_NEXT and mask KS_CHAR>,	;NEXT FIELD
	<0, 0, 0, 0, C_SYS_PREVIOUS and mask KS_CHAR>	;PREVIOUS FIELD
else
		 ;P     C  S     C
		 ;h  A  t  h  S  h
		 ;y  l  r  f  e  a
...
OLWShortcutList	KeyboardShortcut \
		...
		<0, 0, 0, 0, 0xf, VC_RIGHT>,	;NEXT FIELD
		<0, 0, 0, 0, 0xf, VC_LEFT>,	;PREVIOUS FIELD
		<0, 0, 0, 0, 0xf, VC_NEXT>,	;NEXT FIELD
		<0, 0, 0, 0, 0xf, VC_PREVIOUS>	;PREVIOUS FIELD
endif
...
if _JEDIMOTIF
	;
	; JEDI navigates on ENTER if there is not default
	;
	word	MSG_OL_WIN_ACTIVATE_DEFAULT_OR_NAVIGATE
else
...
if _JEDIMOTIF
COMMENT @%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
		OLWinActivateDefaultOrNavigate
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

SYNOPSIS:	Activate default or navigate if no default

CALLED BY:	MSG_OL_WIN_ACTIVATE_DEFAULT_OR_NAVIGATE
...
REVISION HISTORY:
	Name	Date		Description
	----	----		-----------
	brianc	3/ 6/95   	Initial version

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%@
OLWinActivateDefaultOrNavigate	method dynamic OLWinClass, 
					MSG_OL_WIN_ACTIVATE_DEFAULT_OR_NAVIGATE
	;
	; if we've got default, activate it
	;
	mov	ax, MSG_GEN_ACTIVATE_INTERACTION_DEFAULT
	tst	ds:[di].OLWI_defaultExcl.HG_OD.handle
	jnz	sendMessage			; have default, activate it
	;
	; if we've got text focus, allow enter-nav
	;
	mov	bx, ds:[di].OLWI_focusExcl.FTVMC_OD.handle
	tst	bx
	jz	noFocus
	push	si
	mov	si, ds:[di].OLWI_focusExcl.FTVMC_OD.offset
	mov	cx, segment VisTextClass
	mov	dx, offset VisTextClass
	mov	ax, MSG_META_IS_OBJECT_IN_CLASS
	mov	di, mask MF_CALL or mask MF_FIXUP_DS
	call	ObjMessage
	mov	ax, si				; *ds:ax = focus
	pop	si
	jc	noFocus				; is text, allow enter-nav
	;
	; focus is not text, activate focus
	;
	mov	si, ax
...
noFocus:
	call	KN_DerefVisSpec_DI
	ornf	ds:[di].OLWI_moreFixedAttr, mask OWMFA_SELECT_TEXT_ON_NAVIGATE
	mov	ax, TEMP_OL_WIN_ENTER_NAVIGATION
	mov	cx, size optr
	call	ObjVarAddData			; no need to init optr yet
	mov	ax, MSG_GEN_NAVIGATE_TO_NEXT_FIELD	; else, navigate
sendMessage:
	call	ObjCallInstanceNoLock
done:
	ret
OLWinActivateDefaultOrNavigate	endm
endif
...
if _ODIE
SBCS <	cmp	cx, (VC_ISCTRL shl 8) or VC_F8		;F8 is toggle key >
DBCS <	cmp	cx, C_SYS_F8				;F8 is toggle key >
	jne	10$
	test	dh, LCTRL or RCTRL or LSHIFT or RSHIFT or LALT or RALT
	jnz	10$
else
...
if _USE_KBD_ACCELERATORS and (not _NIKE)
	;
...
legosWindowLookHintTable	label word
	word	0
if _PCV
	word	HINT_WINDOW_PCV_TOOL_DIALOG_LOOK
	word	HINT_WINDOW_PCV_FIT_NOTE_PAD_LOOK
	word	HINT_WINDOW_PCV_FIT_NOTE_LOOK
	word	HINT_WINDOW_PCV_ROLODEX_CARD_LOOK
endif
