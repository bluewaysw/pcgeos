...
of a generic interaction group.
	...
	$Id: cspecInteraction.asm,v 2.35 96/07/17 21:37:16 joon Exp $
...
if _RUDY
	mov	dx, offset OLDialogWinClass		;assume "menu"
else
...
EC <	test	dx, mask OLBF_TARGET					>
EC <	ERROR_NZ	OL_BUILD_FLAGS_MULTIPLE_TARGETS			>
PMAN <	ORNF	dx, OLBT_SYS_MENU shl offset OLBF_TARGET
EC <	test	dx, mask OLBF_REPLY					>
EC <	ERROR_NZ	OL_BUILD_FLAGS_MULTIPLE_REPLIES			>
PMAN <	ORNF	dx, OLBR_TOP_MENU shl offset OLBF_REPLY
	ret
