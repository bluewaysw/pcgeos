...
DESCRIPTION:
	...
	$Id: cmainDocumentNew.asm,v 1.16 97/02/03 17:26:36 ptrinh Exp $
...
if SINGLE_DRIVE_DOCUMENT_DIR or _RUDY
...
if _JEDIMOTIF
	;
	; don't report file-not-found error on REOPEN_FILE, just destroy doc
	;
	cmp	ax, SDBT_FILE_OPEN_FILE_NOT_FOUND
	je	returnError
endif
	push	ax, cx, dx, bp
...
if _NIKE
	; if document is untitled and clean, then close it.
...
if 	_JEDIMOTIF
	;
	; Jedi doesn't support user settable empty documents
	;
	stc				
else		
