...
DESCRIPTION:
	...
	$Id: cmainDocObscure.asm,v 1.52 97/04/01 21:08:33 robertg Exp $
...
endif	;DC_DISALLOW_SPACES_FILENAME
...
if not _REDMOTIF ;----------------------- Not needed for Redwood project
if (not _NIKE) and (not _JEDIMOTIF) and (not _DUI) ;- Not needed for Redwood project
