...
DESCRIPTION:
	...
	$Id: cmainDocDialog.asm,v 1.40 96/03/27 16:04:25 stevey Exp $
...
if _NIKE
    StdDialogEntry	<	;SDBT_FILE_OPEN_DEFAULT_DOCUMENT_NOT_FOUND
	<TRUE, CDT_ERROR, GIT_MULTIPLE_RESPONSE>,	;SDE_flags
	0,					;SDE_arg2
	offset SDS_defaultDocumentNotFound,	;SDE_string
	offset SDRT_queryRetryOpenDefaultDoc	;SDE_customTriggers
    >
    StdDialogEntry	<	;SDBT_FILE_OPEN_DEFAULT_DOCUMENT_NEW_DEFAULT
	<TRUE, CDT_QUESTION, GIT_MULTIPLE_RESPONSE>,	;SDE_flags
	0,					;SDE_arg2
	offset SDS_defaultDocumentNewDefault,	;SDE_string
	offset SDRT_okCancel			;SDE_customTriggers
    >
    StdDialogEntry	<	;SDBT_FILE_SAVE_AS_DEFAULT_DOCUMENT_EXISTS
	<TRUE, CDT_QUESTION, GIT_MULTIPLE_RESPONSE>,	;SDE_flags
	0,					;SDE_arg2
	offset SDS_saveAsDefaultDocumentExists,	;SDE_string
	offset SDRT_okCancel			;SDE_customTriggers
    >
endif
...
if _NIKE
SDRT_queryRetryOpenDefaultDoc	label	StandardDialogResponseTriggerTable
	word	3				; SDRTT_numTriggers
	StandardDialogResponseTriggerEntry <
		SDRT_ok,			; SDRTE_moniker
		IC_YES				; SDRTE_responseValue
