...
DESCRIPTION:
	...
	$Id: cutilsManager.asm,v 1.25 97/02/18 18:49:42 reza Exp $
...
ifdef WIZARDBA
	WSHELLBA	equ	1	; we need some constants from WShellBA
	include	wshell.def		; for copenFileSelector.asm, Wizard
	include Internal/heapInt.def	; for copenFileSelector.asm, Wizard
	include	net.def			; for copenFileSelector.asm, Wizard
	UseLib	iclas.def		; for IclasDriveGetStatus, Wizard
endif
