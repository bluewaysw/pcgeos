 ...
 * H = derived HTML_SCRIPT_SUPPORT. It enables script/event collection and
 * AutoBrowse analysis. J additionally enables execution and reparsing HTML
 * generated by document.write. JS and JSDBCS are parser-only products;
