...
DESCRIPTION:
	$Id: copenButtonBW.asm,v 1.3 98/05/04 06:27:49 joon Exp $
...
ISU <	mov	ax, C_BW_GREY		;pass color to use if disabled	>
if USE_COLOR_FOR_DISABLED_GADGETS
	mov	ax, DISABLED_COLOR
endif
...
if _CUA_STYLE and (not _MOTIF)	;----------------------------------------------
	...
	;CUA/ISUI: since menu buttons are the full size of the menu bar,
