...
DESCRIPTION:
	...
	$Id: cwinClassOther.asm,v 1.2 98/03/11 06:07:51 joon Exp $
...
;convertPixels:
	...
	;
	; If the window size is RSA_CHOOSE_OWN_SIZE, it would be a bad
	; idea to attempt computing any ratios.  Leave the size alone.
	;
	push	ax
...
ISU <	inc	ax			;deal with CUA/ISUI 1-pixel overlap >
