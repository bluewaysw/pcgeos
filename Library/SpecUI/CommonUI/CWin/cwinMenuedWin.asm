...
DESCRIPTION:
	...
	$Id: cwinMenuedWin.asm,v 1.5 98/07/10 11:07:54 joon Exp $
...
haveSysMenu:
	...
	pop	si
	;
	; Update window list for primary windows
	;
	mov	di, ds:[si]
...
;COPIED FROM OLWINCLASS SPEC_BUILD HANDLER:
	...
	;ISUI will find the title moniker after it has built the system menu.
