...
entryIsUndottedFile:
	cmp	fileEntry.OLFSE_fileType, GFT_NOT_GEOS_FILE
	je	entryIsDOSFile
	cmp	fileEntry.OLFSE_fileType, GFT_EXECUTABLE
	je	entryIsGeosApp
;entryIsGeosFile:
	mov	si, offset fileIconBitmap		; use file bitmap
	jmp	haveBitmap

entryIsGeosApp:
	mov	si, offset appIconBitmap
	jmp	haveBitmap

entryIsDOSFile:
	mov	si, offset dosIconBitmap
	jmp	haveBitmap
...
FXIP <	pop	bx, ax							>
	...
	mov	dx, GFS_ICON_WIDTH
	clr	cx				; clear cx, bx, ax
	clrdw	bxax
	call	GrRelMoveTo			; move cursor/"pen" GFS_ICON_WIDTH pixels to the right
	clr	dx				; make sure dx is still clean, still no callback routine wanted
...
GFS_ICON_WIDTH = 16
GFS_ICON_HEIGHT = 12		; note blank top line for aesthetics (...what does that mean? MeyerK/2024?)
...
dotsBitmap	label	byte
		Bitmap <GFS_ICON_WIDTH,GFS_ICON_HEIGHT,BMC_PACKBITS,BMF_4BIT or mask BMT_MASK>
	db	0x01, 0x00, 0x00
	db	0xf9, 0xdd
	db	0x01, 0x01, 0x00
	db	0xfe, 0xdd, 0x00, 0xd0, 0xfd, 0xdd
	db	0x01, 0x00, 0x00
	db	0xf9, 0xdd
	db	0x01, 0x01, 0x00
	db	0xfe, 0xdd, 0x00, 0xd0, 0xfd, 0xdd
	...
	db	0xf9, 0xdd
	db	0x01, 0x01, 0x54
	db	0xfe, 0xdd, 0xfd, 0xd0, 0x00, 0xdd
	db	0x01, 0x00, 0x00
	db	0xf9, 0xdd
	db	0x01, 0x00, 0x00
	db	0xf9, 0xdd
	db	0x01, 0x40, 0x00
	db	0x00, 0xd7, 0xfa, 0xdd
	db	0x01, 0x00, 0x00
	db	0xf9, 0xdd

fileIconBitmap	label	byte
		Bitmap <GFS_ICON_WIDTH,GFS_ICON_HEIGHT,0,BMF_4BIT or mask BMT_MASK>
	db	0x03, 0xfe
	db	0xdd, 0xdd, 0xdd, 0x88, 0x88, 0x88, 0x88, 0x8d
	db	0x03, 0xfe
	db	0xdd, 0xdd, 0xdd, 0x8f, 0xff, 0xff, 0xff, 0x8d
	db	0x0f, 0xfe
	db	0xdd, 0xdd, 0x88, 0x88, 0x88, 0x88, 0x8f, 0x8d
	db	0x0f, 0xfe
	db	0xdd, 0xdd, 0x8f, 0xff, 0xff, 0xff, 0x8f, 0x8d
	db	0x3f, 0xfe
	db	0xdd, 0x88, 0x88, 0x88, 0x88, 0x8f, 0x8f, 0x8d
	db	0x3f, 0xfe
	db	0xdd, 0x8f, 0xff, 0xff, 0xff, 0x8f, 0x8f, 0x8d
	db	0x3f, 0xfe
	db	0xdd, 0x8f, 0xff, 0xff, 0xff, 0x8f, 0x8f, 0x8d
	db	0x3f, 0xfe
	db	0xdd, 0x8f, 0x77, 0x77, 0x7f, 0x8f, 0x88, 0x8d
	db	0x3f, 0xf8
	db	0xdd, 0x8f, 0xff, 0xff, 0xff, 0x8f, 0x8d, 0xdd
	db	0x3f, 0xf8
	db	0xdd, 0x8f, 0x77, 0x77, 0x7f, 0x88, 0x8d, 0xdd
	db	0x3f, 0xe0
	db	0xdd, 0x8f, 0xff, 0xff, 0xff, 0x8d, 0xdd, 0xdd
	db	0x3f, 0xe0
	db	0xdd, 0x88, 0x88, 0x88, 0x88, 0x8d, 0xdd, 0xdd

appIconBitmap	label	byte
		Bitmap <GFS_ICON_WIDTH,GFS_ICON_HEIGHT,0,BMF_4BIT or mask BMT_MASK>
	db	0x07, 0xe0
	db	0xdd, 0xdd, 0xd7, 0x70, 0x07, 0x7d, 0xdd, 0xdd
	db	0x0f, 0xf0
	db	0xdd, 0xdd, 0x09, 0xa9, 0x99, 0x90, 0xdd, 0xdd
	db	0x1f, 0xf8
	db	0xdd, 0xd0, 0xaa, 0xaa, 0x99, 0x9a, 0x0d, 0xdd
	db	0x3f, 0xfc
	db	0xdd, 0x7a, 0xaa, 0x99, 0x99, 0xaa, 0x27, 0xdd
	db	0x3f, 0xfc
	db	0xdd, 0x79, 0x9a, 0x99, 0x99, 0x9a, 0x97, 0xdd
	db	0x3f, 0xfc
	db	0xdd, 0x0a, 0x99, 0x99, 0x99, 0xaa, 0xa0, 0xdd
	db	0x3f, 0xfc
	db	0xdd, 0x0a, 0xaa, 0x99, 0x99, 0xaa, 0xa0, 0xdd
	db	0x3f, 0xfc
	db	0xdd, 0x8a, 0xaa, 0x99, 0x99, 0x9a, 0x28, 0xdd
	db	0x3f, 0xfc
	db	0xdd, 0x7a, 0xa9, 0x99, 0x99, 0x91, 0x27, 0xdd
	db	0x1f, 0xf8
	db	0xdd, 0xd0, 0xa9, 0x99, 0x99, 0x11, 0x0d, 0xdd
	db	0x0f, 0xf0
	db	0xdd, 0xdd, 0x01, 0x99, 0x91, 0x10, 0xdd, 0xdd
	db	0x07, 0xe0
	db	0xdd, 0xdd, 0xd8, 0x80, 0x08, 0x8d, 0xdd, 0xdd


dosIconBitmap	label	byte
		Bitmap <GFS_ICON_WIDTH,GFS_ICON_HEIGHT,BMC_PACKBITS,BMF_4BIT or mask BMT_MASK>
	db	0x01, 0xff, 0xfe
	db	0xfa, 0x11, 0x00, 0x1d
	db	0x01, 0xff, 0xfe
	db	0x00, 0x1f, 0xfb, 0xff, 0x00, 0x1d
	db	0x01, 0xff, 0xfe
	db	0x07, 0x1f, 0x00, 0xff, 0xf0, 0xff, 0xf0, 0xff,
		0x1d
	db	0x01, 0xff, 0xfe
	db	0x00, 0x1f, 0xfb, 0x0f, 0x00, 0x1d
	db	0x01, 0xff, 0xfe
	db	0x00, 0x1f, 0xfc, 0x0f, 0x01, 0xff, 0x1d
	db	0x01, 0xff, 0xfe
	db	0x00, 0x1f, 0xfd, 0x0f, 0x02, 0xf0, 0xff, 0x1d
	db	0x01, 0xff, 0xfe
	db	0x00, 0x1f, 0xfd, 0x0f, 0x02, 0xff, 0x0f, 0x1d
	db	0x01, 0xff, 0xfe
	db	0x00, 0x1f, 0xfd, 0x0f, 0x02, 0xff, 0x0f, 0x1d
	db	0x01, 0xff, 0xfe
	db	0x00, 0x1f, 0xfb, 0x0f, 0x00, 0x1d
...
folderIconBitmap	label	byte
	...
	db	0x00, 0x78
	db	0xdd, 0xdd, 0xdd, 0xdd, 0xd8, 0x88, 0x8d, 0xdd
	db	0x00, 0xfc
	db	0xdd, 0xdd, 0xdd, 0xdd, 0x8f, 0xff, 0xf8, 0xdd
	db	0x3f, 0xfe
	db	0xdd, 0x88, 0x88, 0x88, 0xfe, 0xee, 0xee, 0x8d
	db	0x7f, 0xfe
	db	0xd8, 0xff, 0xff, 0xff, 0x77, 0x77, 0x77, 0x8d
	db	0x7f, 0xfe
	db	0xd8, 0xfe, 0xee, 0xee, 0xee, 0xee, 0xe7, 0x8d
	db	0x7f, 0xfe
	db	0xd8, 0xfe, 0xee, 0xee, 0xee, 0xee, 0x77, 0x8d
	db	0x7f, 0xfe
	db	0xd8, 0xfe, 0xee, 0xee, 0xee, 0xe7, 0x77, 0x8d
	db	0x7f, 0xfe
	db	0xd8, 0xfe, 0xee, 0xee, 0xee, 0xe7, 0x77, 0x8d
	db	0x7f, 0xfe
	db	0xd8, 0xee, 0xee, 0xee, 0xee, 0x77, 0x77, 0x8d
	db	0x7f, 0xfe
	db	0xd8, 0x77, 0x77, 0x77, 0x77, 0x77, 0x77, 0x8d
	db	0x3f, 0xfc
	db	0xdd, 0x88, 0x88, 0x88, 0x88, 0x88, 0x88, 0xdd
endif
...
openFolderIconBitmap	label	byte
	...
	db	0xdd, 0xdd, 0xdd, 0xdd, 0xdd, 0xdd, 0xdd, 0xdd
	db	0x00, 0x3c
	db	0xdd, 0xdd, 0xdd, 0xdd, 0xdd, 0x88, 0x88, 0xdd
	db	0x00, 0x7e
	db	0xdd, 0xdd, 0xdd, 0xdd, 0xd8, 0xff, 0xff, 0x8d
	db	0x0f, 0xff
	db	0xdd, 0xdd, 0x88, 0x88, 0x8f, 0xee, 0xee, 0x78
	db	0x1f, 0xff
	db	0xdd, 0xd8, 0xff, 0xff, 0xfe, 0xee, 0xe7, 0x78
	db	0x1f, 0xff
	db	0xdd, 0xd8, 0xfe, 0xee, 0xee, 0xee, 0xe7, 0x78
	db	0x1f, 0xff
	db	0xdd, 0xd8, 0xfe, 0xee, 0xee, 0xee, 0x77, 0x78
	db	0x7f, 0xff
	db	0xd8, 0x88, 0x88, 0x88, 0x88, 0x88, 0x88, 0x78
	db	0x7f, 0xff
	db	0xd8, 0x77, 0x77, 0x77, 0x77, 0x77, 0x78, 0x78
	db	0x3f, 0xff
	db	0xdd, 0x87, 0x77, 0x77, 0x77, 0x77, 0x77, 0x88
	db	0x3f, 0xff
	db	0xdd, 0x87, 0x77, 0x77, 0x77, 0x77, 0x77, 0x88
	db	0x1f, 0xfe
	db	0xdd, 0xd8, 0x88, 0x88, 0x88, 0x88, 0x88, 0x8d

disk525IconBitmap	label	byte
		Bitmap <GFS_ICON_WIDTH, GFS_ICON_HEIGHT, 0, BMF_MONO>
...
diskHDIconBitmap	label	byte
	...
	db	0xf9, 0xdd
	db	0x01, 0x7f, 0xfe
	db	0x00, 0xd0, 0xfb, 0x00, 0x00, 0x0d
	db	0x01, 0x7f, 0xfe
	db	0x00, 0xd0, 0xfb, 0x00, 0x00, 0x0d
	db	0x01, 0x6f, 0xfe
	db	0x02, 0xd0, 0x0d, 0x22, 0xfd, 0x00, 0x00, 0x0d
	db	0x01, 0x7f, 0xfe
	db	0x00, 0xd0, 0xfb, 0x00, 0x00, 0x0d
	db	0x01, 0x7f, 0xfe
	db	0x00, 0xd0, 0xfb, 0x00, 0x00, 0x0d
	...
	db	0x00, 0xd0, 0xfb, 0x00, 0x00, 0x0d
	db	0x01, 0x6f, 0xfe
	db	0x02, 0xd0, 0x0d, 0x44, 0xfd, 0x00, 0x00, 0x0d
	db	0x01, 0x7f, 0xfe
	db	0x00, 0xd0, 0xfb, 0x00, 0x00, 0x0d
	db	0x01, 0x7f, 0xfe
	db	0x00, 0xd0, 0xfb, 0x00, 0x00, 0x0d
