...
appIconBitmap	label	byte
	...
	db	0x0f, 0xe0
	db	0xdd, 0xdd, 0xcc, 0xb9, 0x99, 0x9d, 0xdd, 0xdd
	db	0x0f, 0xf0
	db	0xdd, 0xdd, 0xc7, 0xb9, 0x99, 0x99, 0xdd, 0xdd
	db	0x0f, 0xf0
	db	0xdd, 0xdd, 0xcb, 0xbb, 0x99, 0x99, 0xdd, 0xdd
	db	0x0f, 0xf0
	db	0xdd, 0xdd, 0xcb, 0xb9, 0x99, 0x99, 0xdd, 0xdd
	db	0x0f, 0xf0
	db	0xdd, 0xdd, 0xcb, 0xb9, 0x9b, 0xb9, 0xdd, 0xdd
	db	0x0f, 0xf0
	db	0xdd, 0xdd, 0xc7, 0xbb, 0xbb, 0xb9, 0xdd, 0xdd
	db	0x0f, 0xf0
	db	0xdd, 0xdd, 0xcc, 0x7b, 0xbb, 0xb7, 0xdd, 0xdd
	db	0x07, 0xf0
	db	0xdd, 0xdd, 0xdc, 0xcc, 0x77, 0xcc, 0xdd, 0xdd
	db	0x01, 0xc0
	db	0xdd, 0xdd, 0xdd, 0xdc, 0xcc, 0xdd, 0xdd, 0xdd
	db	0x01, 0x80
	db	0xdd, 0xdd, 0xdd, 0xdc, 0xcd, 0xdd, 0xdd, 0xdd
	db	0x0f, 0xf0
	db	0xdd, 0xdd, 0xcc, 0xcc, 0xcc, 0xcc, 0xdd, 0xdd
