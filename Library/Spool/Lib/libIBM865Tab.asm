...
PROJECT:	PC GEOS
MODULE:		Spooler
FILE:		libIBM865Tab.asm

DESCRIPTION:
		Code page 865 conversion table for the top 128 bytes

	$Id: libIBM865Tab.asm,v 1.1 97/04/07 11:10:49 newdeal Exp $

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%@

IBM865Table	segment	resource
...
;Table	label	byte
		...
		byte	C_SPACE	;C_GUILLEDBLRIGHT, 0xc8
