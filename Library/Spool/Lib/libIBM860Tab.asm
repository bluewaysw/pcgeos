...
PROJECT:	PC GEOS
MODULE:		Spooler
FILE:		libIBM860Tab.asm

DESCRIPTION:
		Code page 860 conversion table for the top 128 bytes

	$Id: libIBM860Tab.asm,v 1.1 97/04/07 11:10:55 newdeal Exp $

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%@

IBM860Table	segment	resource
...
;Table	label	byte
		...
		byte	C_SPACE	;C_LE_DIERESIS	, 0x91
		byte	0xa1	;C_LI_ACUTE	, 0x92
		byte	0x8d	;C_LI_GRAVE	, 0x93
		byte	C_SPACE	;C_LI_CIRCUMFLEX, 0x94
		...
		byte	0x94	;C_LO_TILDE	, 0x9b
		byte	0xa3	;C_LU_ACUTE	, 0x9c
		byte	0x97	;C_LU_GRAVE	, 0x9d
		byte	C_SPACE	;C_LU_CIRCUMFLEX, 0x9e
		...
		byte	0x91	;C_UA_GRAVE	, 0xcb
		byte	0x8e	;C_UA_TILDE	, 0xcc
		byte	0x99	;C_UO_TILDE	, 0xcd
		...
		byte	0x8f	;C_UA_CIRCUMFLEX, 0xe5
		byte	0x89	;C_UE_CIRCUMFLEX, 0xe6
		byte	0xa0	;C_UA_ACUTE	, 0xe7
		byte	C_SPACE	;C_UE_DIERESIS	, 0xe8
		byte	0x92	;C_UE_GRAVE	, 0xe9
		byte	0x8b	;C_UI_ACUTE	, 0xea
		byte	C_SPACE	;C_UI_CIRCUMFLEX, 0xeb
		byte	C_SPACE	;C_UI_DIERESIS	, 0xec
		byte	0x98	;C_UI_GRAVE	, 0xed
		byte	0x9f	;C_UO_ACUTE	, 0xee
		byte	0x8c	;C_UO_CIRCUMFLEX, 0xef
		byte	C_SPACE	;C_LOGO		, 0xf0
		byte	0xa9	;C_UO_GRAVE	, 0xf1
		byte	0x96	;C_UU_ACUTE	, 0xf2
