...
DESCRIPTION:
	Contains character map for IBM Portuguese --> PC/GEOS
		
	$Id: cmapPort.asm,v 1.1 97/04/05 01:16:28 newdeal Exp $

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%@

PortugueseMap	segment	resource

codePagePortuguese	Chars \
	C_UC_CEDILLA,		;0x80
	C_LU_DIERESIS,		;0x81
	C_LE_ACUTE,		;0x82
	...
	C_UE_CIRCUMFLEX,	;0x89
	C_LE_GRAVE,		;0x8a
	C_UI_ACUTE,		;0x8b
	C_UO_CIRCUMFLEX,	;0x8c
	C_LI_GRAVE,		;0x8d
	C_UA_TILDE,		;0x8e
	C_UA_CIRCUMFLEX,	;0x8f
	C_UE_ACUTE,		;0x90
	C_UA_GRAVE,		;0x91
	C_UE_GRAVE,		;0x92
...
toPortCodePage	Char \
	...
	0,			; C_ELLIPSIS,		0xc9
	' ',			; C_NONBRKSPACE		0xca
	0x91,			; C_UA_GRAVE,		0xcb
	0x8e,			; C_UA_TILDE,		0xcc
	0x99,			; C_UO_TILDE,		0xcd
	'O',			; C_U_OE,		0xce
	'o',			; C_L_OE,		0xcf
	'-',			; C_ENDASH,		0xd0
	'-',			; C_EMDASH,		0xd1
	...
	0x8f,			; C_UA_CIRCUMFLEX,	0xe5
	0x89,			; C_UE_CIRCUMFLEX,	0xe6
	0x86,			; C_UA_ACUTE,		0xe7
	'E',			; C_UE_DIERESIS,	0xe8
	0x92,			; C_UE_GRAVE,		0xe9
	0x8b,			; C_UI_ACUTE		0xea
	'I',			; C_UI_CIRCUMFLEX,	0xeb
	'I',			; C_UI_DIERESIS,	0xec
	0x98,			; C_UI_GRAVE,		0xed
	0x9f,			; C_UO_ACUTE,		0xee
	0x8c,			; C_UO_CIRCUMFLEX,	0xef
	0,			; C_LOGO,		0xf0
	0xa9,			; C_UO_GRAVE,		0xf1
	0x96,			; C_UU_ACUTE,		0xf2
	...
	ForceRef	codePagePortuguese
	ForceRef	toPortCodePage
