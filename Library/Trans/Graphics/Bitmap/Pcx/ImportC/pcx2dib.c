...
ImportPcx(FILE * pcxfile,FILE * dibfile)
   ...
   _outtext(" ���������������������������������������������������������������������������͹ \n");
   _outtext(" �                                                                           � \n");
   _outtext(" �   Description: This program converts PaintBrush PCX file to Windows 3.0   � \n");
   _outtext(" �                Device Independent Bitmap (DIB) format.                    � \n");
   _outtext(" �                                                                           � \n");
   _outtext(" �   Usage:       PCX2DIB {-v, -h}  <Infile> <outfile>                       � \n");
   _outtext(" �                                                                           � \n");
   _outtext(" �       -v       : Verbose (optional)                                       � \n");
   _outtext(" �       -h       : Display help screen                                      � \n");
   _outtext(" �       <infile> : PaintBrush PCX file name                                 � \n");
