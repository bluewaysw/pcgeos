...
ImportClp(FILE * clpfile,FILE * dibfile)
   ...
   _outtext(" ���������������������������������������������������������������������������͹ \n"); 
   _outtext(" �                                                                           � \n"); 
   _outtext(" �   Description: This program converts Windows CLP bitmap to Windows 3.0    � \n"); 
   _outtext(" �                Device Independent Bitmap (DIB) format.                    � \n"); 
   _outtext(" �                                                                           � \n"); 
   _outtext(" �   Usage:       CLP2DIB {-v, -h}  <Infile> <outfile>                       � \n"); 
   _outtext(" �                                                                           � \n"); 
   _outtext(" �       -v       : Verbose (optional)                                       � \n"); 
   _outtext(" �       -h       : Display help screen                                      � \n"); 
   _outtext(" �       <infile> : Windows Clipboard Bitmap file name                       � \n"); 
