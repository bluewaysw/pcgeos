...
DESCRIPTION:
	...
	$Id: libMain.asm,v 1.1 97/04/07 11:26:20 newdeal Exp $
...
RETURN:		dx	- handle of block containing BMPExportBlock structure
...
;allocate a block to hold the Export Options
	...
	mov	ds:[BEO_format],ax

	pop	ax		;restore BitCount selection
	mov	ds:[BEO_bitCount],al
