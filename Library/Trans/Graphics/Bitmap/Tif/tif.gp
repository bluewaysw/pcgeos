...
#
#
# Parameters file for: tif translation library  
#
#	$Id: tif.gp,v 1.1 97/04/07 11:28:06 newdeal Exp $
#
##############################################################################
#
# Permanent name
...
#resource CPT4	read-only code shared
#resource LZWCCODE read-only code shared
#resource TIFFSAVE read-only code shared
#resource DIB	read-only code shared
#resource FIXSHORT	read-only code shared
#resource HSIPORT	read-only code shared
#resource PACKBIT	read-only code shared
#resource DCPT4	read-only code shared
#resource LZW	read-only code shared
#resource TIFFLOAD	read-only code shared
