...
static void add_node(register NODE *node, register NODE *cur_node);
static void free_tree(register NODE *node);
...
static void
add_node(register NODE *node, register NODE *cur_node)
{
