...
#ifndef lint
static char *rcsid =
"$Id: lstCat.c,v 1.3 96/06/24 14:58:16 tbradley Exp $ SPRITE (Berkeley)";
#endif lint
 ...
 */
ReturnStatus
Lst_Concat (Lst l1, 	/* The list to which l2 is to be appended */
				 ...
				 * LST_CONCLINK if should just be relinked */
{
	...
	if (list2->firstPtr != NilListNode) {
		...
		/*
		 * First list empty, so make first element of 2nd list the
