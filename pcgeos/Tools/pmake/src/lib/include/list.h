 ...
 * All rights reserved.
 *
 * rcsid "$Id: list.h,v 1.1 96/06/24 14:57:20 tbradley Exp $ SPRITE (Berkeley)"
 */
...
void	List_Init   (List_Links *); /* initialize a header to a list */
void    List_Insert (List_Links *, List_Links *);
                                    /* insert an element into a list */
void 	List_Remove (List_Links *); /* remove an element from a list */
void 	List_Move   (List_Links *, List_Links *);
