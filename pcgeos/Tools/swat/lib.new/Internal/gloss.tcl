...
#
#	$Id: gloss.tcl,v 3.5.12.1 97/03/29 11:25:07 canavese Exp $
#
######################################################################
#
...
[defcommand gloss {args} support.reference
...
[defcommand ref {{target nil}} support.reference
...
#	xref command
#
[defcommand xref {{target nil}} support.reference
