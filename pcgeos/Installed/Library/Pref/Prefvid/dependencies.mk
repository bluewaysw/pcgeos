prefvid.rdef: 	prefvid.ui

prefvid.obj \
prefvid.eobj: geos.def heap.def geode.def resource.def ec.def assert.def \
                disk.def file.def drive.def library.def object.def \
                lmem.def graphics.def fontID.def font.def color.def \
                gstring.def text.def char.def win.def initfile.def \
                driver.def ui.def vm.def input.def hwr.def localize.def \
                ...
                config.def Objects/colorC.def Internal/videoDr.def \
                prefvidDialog.def prefvidDeviceList.def \
                prefvidGadgets.def prefvid.def prefvid.rdef \
                prefvidDeviceList.asm prefvidDialog.asm \
                prefvidGadgets.asm
