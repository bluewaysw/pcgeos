prefcomp.rdef:		prefcomp.ui 
prefcomp.obj \
prefcomp.eobj: geos.def heap.def geode.def resource.def ec.def \
                library.def object.def lmem.def graphics.def fontID.def \
                font.def color.def gstring.def text.def char.def win.def \
                system.def localize.def sllang.def Objects/inputC.def \
                Objects/metaC.def chunkarr.def geoworks.def initfile.def \
                ui.def file.def vm.def input.def hwr.def \
                ...
                dbase.def Internal/serialDr.def Internal/streamDr.def \
                driver.def Internal/parallDr.def prefcomp.def \
                prefcomp.rdef prefcompSerialValue.asm
