prefsnd.rdef:		prefsnd.ui 
prefsnd.obj \
prefsnd.eobj: geos.def heap.def geode.def resource.def ec.def \
                library.def object.def lmem.def graphics.def fontID.def \
                font.def color.def gstring.def text.def char.def win.def \
                initfile.def ui.def file.def vm.def input.def hwr.def \
                ...
                config.def Objects/colorC.def prefsnd.def prefsnd.rdef
