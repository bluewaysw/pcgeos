parentControl.rdef:	parentControl.ui 

parentcManager.obj \
parentcManager.eobj: geos.def geode.def resource.def lmem.def file.def vm.def \
                hugearr.def initfile.def heap.def gstring.def \
                graphics.def fontID.def font.def color.def text.def \
                char.def ec.def config.def ui.def win.def input.def \
                ...
                Objects/colorC.def Objects/vTextC.def spool.def print.def \
                Internal/prodFeatures.def dbase.def parentc.def \
                parentControl.rdef parentControl.asm parentcURLs.asm
