taipei.rdef:		taipei.ui 

taipeiManager.obj \
taipeiManager.eobj: stdapp.def geos.def geode.def resource.def ec.def lmem.def \
                ...
                timer.def Objects/winC.def Objects/inputC.def \
                Objects/vTextC.def spool.def print.def \
                Internal/prodFeatures.def hugearr.def dbase.def \
                assert.def game.def taipei.def taipei.rdef \
                taipeiContent.asm taipei.asm taipeiInit.asm util.asm
