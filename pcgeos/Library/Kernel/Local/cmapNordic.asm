...
DESCRIPTION:
	Contains character map for IBM Nordic --> PC/GEOS
		
	$Id: cmapNordic.asm,v 1.1 97/04/05 01:16:57 newdeal Exp $

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%@

NordicMap	segment resource

codePageNordic	Chars \
	C_UC_CEDILLA,		;0x80
	C_LU_DIERESIS,		;0x81
	C_LE_ACUTE,		;0x82
...
toNordicCodePage	Char \
	...
	ForceRef	codePageNordic
	ForceRef	toNordicCodePage
