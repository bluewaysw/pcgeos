...
PROJECT:	PC GEOS
MODULE:		Spooler
FILE:		libRoman8bitTab.asm

DESCRIPTION:
	conversion table for the upper 128 characters of the 
	GEOS symbol set to roman8 symbol set.
		

	$Id: libRoman8bitTab.asm,v 1.1 97/04/07 11:10:45 newdeal Exp $

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%@

RomanTable	segment	resource
...
; Roman8Tab:
	...
	byte	C_SPACE	;C_ENDASH	, 0xd0
	byte	246	;C_EMDASH	, 0xd1
	...
	byte	178	;C_LY_ACUTE	, 0xde
	byte	177	;C_UY_ACUTE	, 0xdf
	byte	C_SPACE	;C_DBLDAGGER	, 0xe0
	byte	242	;C_CNTR_DOT	, 0xe1
	...
	byte	237	;C_UU_ACUTE	, 0xf2
	byte	174	;C_UU_CIRCUMFLEX, 0xf3
	byte	173	;C_UU_GRAVE	, 0xf4
	byte	C_SPACE	;C_LI_DOTLESS	, 0xf5
	byte	170	;C_CIRCUMFLEX	, 0xf6
	byte	172	;C_TILDE	, 0xf7
	byte	176	;C_MACRON	, 0xf8
