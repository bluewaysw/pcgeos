...
PROJECT:	PC GEOS
MODULE:		Spooler
FILE:		libLatin8bitTab.asm

DESCRIPTION:
	conversion table for upper 128 characters of GEOS symbol set to 
	Latin 1 symbol set
		

	$Id: libLatin8bitTab.asm,v 1.1 97/04/07 11:10:46 newdeal Exp $

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%@

LatinTable	segment	resource
