...
DESCRIPTION:
	$Id: citemItemGroupCommon.asm,v 1.1 97/04/07 10:55:47 newdeal Exp $
...
20$:
	...
	pop	si
	;
	; tell menu to make sure focused item is visible (for scrollable
	; menus)
	;
	call	IC_DerefVisDI
	test	ds:[di].OLCI_optFlags, mask OLCOF_IN_MENU
	jz	noUpdate
	push	si
	mov	ax, MSG_OL_MENU_WIN_UPDATE_SCROLLABLE_MENU
...
OLItemGroupGainedFocusExcl	method	dynamic OLItemGroupClass, \
	...
	;intermediate mode hooey) ask this parent if it has the focus.
