...
//
// Some extra stuff taken from wingdi.h
//
#define WFF_DONTCARE         0  /* Don't care or don't know. */
#define WFF_ROMAN            1  /* Variable stroke width, serifed. */
                                /* Times Roman, Century Schoolbook, etc. */
#define WFF_SWISS            2  /* Variable stroke width, sans-serifed. */
                                /* Helvetica, Swiss, etc. */
#define WFF_MODERN           3  /* Constant stroke width, serifed or sans-serifed. */
                                /* Pica, Elite, Courier, etc. */
#define WFF_SCRIPT           4  /* Cursive, etc. */
#define WFF_DECORATIVE       5  /* Old English, etc. */
