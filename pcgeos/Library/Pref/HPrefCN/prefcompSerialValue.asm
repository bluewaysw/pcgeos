...
DESCRIPTION:
	...
	$Id: prefcompSerialValue.asm,v 1.1 97/04/05 01:37:50 newdeal Exp $
...

COMMENT @%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
		PrefCompSerialValueSpecBuild
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

SYNOPSIS:	Take care of setting min and max values for the machine
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%@
PrefCompSerialValueSpecBuild method dynamic PrefCompSerialValueClass, 
			     	MSG_SPEC_BUILD
		.enter
	...
	; interrupt controller in the machine.
	; 
		call	SysGetConfig
...
haveMax:
		...
		.leave
		ret
PrefCompSerialValueSpecBuild endm
