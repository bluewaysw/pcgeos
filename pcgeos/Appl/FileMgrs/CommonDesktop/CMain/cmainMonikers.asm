...
;-----------------------------------------------------------------
;	DocManager monikers that are installed in the token.db.
;	(changed from GeoManager to avoid conflict if we ship
;	 GeoManager)
;-----------------------------------------------------------------
desktopMonikerTable	label	TokenMoniker
if _APP_MONIKER
TokenMoniker	< <'DMGR'>,	DeskMonikerList			>
endif
TokenMoniker	< <'dFLD'>,	FldrMonikerList			>
TokenMoniker	< <'dAPP'>,	DefaultGEOSApplMonikerList	>
TokenMoniker	< <'dDAT'>,	DefaultGEOSDataMonikerList	>
TokenMoniker	< <'dDOS'>,	DosApplMonikerList		>
TokenMoniker	< <'dFIL'>,	FileMonikerList			>
byte		TOKEN_MONIKER_END_OF_LIST
