...
NOFXIP<	segmov	es, dgroup, ax						>
	...
	; If view background color is white, then use the folderBackgroundColor

	mov	cl, es:[folderBackgroundColor]
...

COMMENT @%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
		NDDesktopViewSpecBuildBranch
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

SYNOPSIS:	initialize background color before building
...
NDDesktopViewUpdateBGColor	method	dynamic	NDDesktopViewClass, 
...
donePop:
	...
	ret
NDDesktopViewUpdateBGColor	endm
endif ; _NEWDESK
