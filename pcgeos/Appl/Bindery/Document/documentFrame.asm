...
METHODS:
	Name			Description
	----			-----------
    WrapFrameInitToDefaultAttrs Set special attributes

				MSG_GO_INIT_TO_DEFAULT_ATTRS
				WrapFrameClass

    WrapFrameCompleteCreate	Handle completion of a create by switching
				to the pointer tool

				MSG_GO_COMPLETE_CREATE
				WrapFrameClass

    WrapFrameEndCreate		Finish creating an object
...
DESCRIPTION:
	...
	$Id: documentFrame.asm,v 1.1 97/04/04 14:38:43 newdeal Exp $
