...
#
# PROJECT:	GEOS
# MODULE:	ClipSamp (Clipboard Sample GEOS application)
# FILE:		clipsamp.gp
#
# AUTHOR:	brianc, 3/91
#
...
#
# RCS STAMP:
#	$Id: clipsamp.gp,v 1.1 97/04/04 16:32:36 newdeal Exp $
#
##############################################################################
#
...
# process will be handled by the ClipSampProcessClass, which is defined
# in hello.asm.
#
class	ClipSampProcessClass
#
# Specify application object. This is the object in the .ui file which serves
# as the top-level UI object in the application. See clipsamp.ui.
#
appobj	ClipSampApp
#
