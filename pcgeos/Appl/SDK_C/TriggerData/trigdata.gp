...
# MODULE:	GenTrigger Data-passing test app
# FILE:		trigdata.gp
#
# AUTHOR:	Eric E. Del Sesto, 11/90
#
# DESCRIPTION:	This file contains Geode definitions for the
#		"TriggerData" sample application. 
#
# RCS STAMP:
#	$Id: trigdata.gp,v 1.1 97/04/04 16:37:52 newdeal Exp $
#
##############################################################################
#
...
# process will be handled by the TriggerDataProcessClass, which is defined
# in triggerdata.asm.
#
class	TriggerDataProcessClass
#
# Specify application object. This is the object in the .ui file which serves
# as the top-level UI object in the application. 
#
appobj	TriggerDataApp
#
