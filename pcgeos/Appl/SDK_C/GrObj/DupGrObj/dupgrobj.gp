...
#
# PROJECT:      DupGrObj Sample Application
...
#       NF      9/18/96         Corrected heapspace and tokenchars
#       NF      10/4/96         Corrected heapspace value again
#
# DESCRIPTION:
#       This file contains Geode definitions for the "DupGrObj" sample
#       application. This file is read by the GLUE linker to
#       build this application.
#
# RCS STAMP:
#       $Id: dupgrobj.gp,v 1.1 97/04/04 16:37:59 newdeal Exp $
#
#####################################################################
#
...
# 6000 is between 6246 and 5845, which are the high/low values I
# got from Swat at different times while running the app.
#
heapspace 6000
#
...
resource BODYGOAM    object read-only shared
#
