...
DESCRIPTION:
	...
	$Id: documentFlow.asm,v 1.1 97/04/04 15:56:08 newdeal Exp $
...
sendNotification:
	...
	mov	ax, MSG_WRITE_DOCUMENT_FLOW_REGION_CHANGED
...
DESCRIPTION:	Write our instance data the the transfer item
