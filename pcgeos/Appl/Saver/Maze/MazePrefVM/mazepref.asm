...
DESCRIPTION:
	Saver-specific preferences for Maze driver.
		

	$Id: mazepref.asm,v 1.1 97/04/04 16:45:43 newdeal Exp $
...
;
; Include constants from Maze, the saver, for use in our objects.
;
include ../maze.def
