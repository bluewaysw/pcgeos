# $Id: local.mk,v 1.1 97/04/04 16:47:50 newdeal Exp $
GSUFF		= vm
#
...
#
#if defined(DO_DBCS)
LINKFLAGS       += -i $(ROOT_DIR)/Installed/Appl/Preferences/PrefMgr/prefmgr.geo -N "Ticker Tape" -t "VMPD" -l "Tickertape Opts"
#else
LINKFLAGS       += -i $(ROOT_DIR)/Installed/Appl/Preferences/PrefMgr/prefmgr.geo -N "Ticker Tape" -t "VMPD" -l "Tickertape Options"
#endif
