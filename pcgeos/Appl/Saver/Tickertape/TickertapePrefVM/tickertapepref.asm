...
DESCRIPTION:
	Saver-specific preferences for Tickertape driver.
		

	$Id: tickertapepref.asm,v 1.1 97/04/04 16:47:48 newdeal Exp $
...
;
; Include constants from Tickertape, the saver, for use in our objects.
;
