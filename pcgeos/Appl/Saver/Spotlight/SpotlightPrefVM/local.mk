# $Id: local.mk,v 1.1 97/04/04 16:45:17 newdeal Exp $
GSUFF		= vm
#
...
#
LINKFLAGS	+= -i $(ROOT_DIR)/Installed/Appl/Preferences/PrefMgr/prefmgr.geo -N "Spotlight" -t "VMPD" -l "Spotlight Options"
#
