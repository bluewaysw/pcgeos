...
DESCRIPTION:
	Saver-specific preferences for Pieces driver.
		

	$Id: piecespref.asm,v 1.1 97/04/04 16:46:36 newdeal Exp $
...
;
; Include constants from Pieces, the saver, for use in our objects.
;
include ../pieces.def
