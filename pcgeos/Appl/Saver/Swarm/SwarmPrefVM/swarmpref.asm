...
DESCRIPTION:
	Saver-specific preferences for Swarm driver.
		

	$Id: swarmpref.asm,v 1.1 97/04/04 16:47:25 newdeal Exp $
...
;
; Include constants from Swarm, the saver, for use in our objects.
;
include ../swarm.def
