# $Id: local.mk,v 1.1 97/04/04 16:46:25 newdeal Exp $
GSUFF		= vm
#
...
#
LINKFLAGS	+= -i $(ROOT_DIR)/Installed/Appl/Preferences/PrefMgr/prefmgr.geo -N "Palette Basher" -t "VMPD" -l "Palette Options"
#
