...
DESCRIPTION:
	...
	$Id: dos7Utils.asm,v 1.1 97/04/10 11:55:32 newdeal Exp $
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%@
PathOps_LoadVarSegES	proc	near
		.enter
		mov	es, cs:[pathOps_dgroupSeg]
		.leave
		ret
PathOps_LoadVarSegES	endp
...
DOSUtilOpen proc near
	...
	;
		...
		clr	bh
		mov	bl, al			; bx <- access flags
		push	bx
		clr	cx			; cx <- attributes	
		clr	di			; di <- alias hint (none)
		...
		or	bl, FileAccessFlags <FE_NONE,0>
		mov	ax,  MSDOS7F_CREATE_OR_OPEN
		call	DOSUtilInt21
