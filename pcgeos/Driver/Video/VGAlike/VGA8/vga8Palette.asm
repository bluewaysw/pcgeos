...
DESCRIPTION:
	This file contains the default palette used by the View800 driver.
		
	$Id: vga8Palette.asm,v 1.1 97/04/18 11:42:01 newdeal Exp $
...
SetDevicePalette proc	near
		uses	si, ds, es, di, cx, ax, bx
		.enter

		mov	si, cs
		mov	ds, si

		mov	ax, 256 * size RGBValue
...
entryLoop:
		...
		; call BIOS to actually set the palette
