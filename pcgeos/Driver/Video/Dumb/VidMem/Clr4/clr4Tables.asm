...
DESCRIPTION:
	...
	$Id: clr4Tables.asm,v 1.1 97/04/18 11:42:45 newdeal Exp $
...
driverJumpTable	label	word
	...
	dw	offset Clr4:VidGetPixel		; get a pixel color
	dw	offset Clr4:Clr4CallMod		; GetBits in another module
	...
	dw	offset Clr4:VidDrawRect		; rectangle
	dw	offset Clr4:VidPutString	; char string
	dw	offset Clr4:Clr4CallMod		; BitBlt in another module
	dw	offset Clr4:Clr4CallMod		; PutBits in another module
	dw	offset Clr4:Clr4CallMod		; DrawLine in another module
	dw	offset Clr4:VidDrawRegion	; draws a region
	dw	offset Clr4:Clr4CallMod		; PutLine in another module
	dw	offset Clr4:Clr4CallMod		; Polygon in another module
	dw	0				; ScreenOn in another module
	dw	0				; ScreenOff in another module
	dw	offset Clr4:Clr4CallMod		; Polyline in another module
	dw	offset Clr4:Clr4CallMod		; Polyline in another module
	dw	offset Clr4:Clr4CallMod		; Polyline in another module
	dw	0				; SetPalette
	dw	0				; GetPalette
...
moduleTable	label	fptr
	...
	fptr	Clr4Misc:VidGetBits	 	; GetBits in another module
	...
	fptr	0				; rectangle
	fptr	0				; char string
	fptr	Clr4Blt:VidBitBlt		; BitBlt in another module
	fptr	Clr4Bitmap:VidPutBits	  	; PutBits in another module
	fptr	Clr4Line:VidDrawLine		; DrawLine in another module
	fptr	0				; draws a region
	fptr	Clr4PutLine:VidPutLine		; PutLine in another module
	fptr	Clr4Line:VidPolygon		; Polygon in another module
	fptr	0				; ScreenOn in another module
	fptr	0				; ScreenOff in another module
	fptr	Clr4Line:VidPolyline		; Polyline in another module
	fptr	Clr4Line:VidDashLine		; DashLine in another module
	fptr	Clr4Line:VidDashFill		; DashFill in another module
...
FCC_table	label	word
	dw	offset Clr4:Char1In	;load 1
	dw	offset Clr4:Char2In	;load 2
	dw	offset Clr4:Char3In	;load 3
	dw	offset Clr4:Char4In	;load 4
