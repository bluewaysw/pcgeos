...
DESCRIPTION:
	...
	$Id: qjetplusInfo.asm,v 1.1 97/04/18 11:52:15 newdeal Exp $
...
PrinterInfo		   <       ; ---- PrinterType -------------
				...
				NULL,		
                                ...
                                offset printerFontInfo:qjetnlq,
                                        ; ---- Font Geometry -----------
                                offset qjetpfontGeometries,
                                        ; ---- Symbol Set list -----------
                                offset qjetpSymbolSets,
                                        ; ---- PaperMargins ------------
...
qjetplowRes      GraphicsProperties < LO_RES_X_RES,      ; xres
                                     LO_RES_Y_RES,      ; yres
...
qjetphiRes       GraphicsProperties < HI_RES_X_RES,      ; xres
                                     HI_RES_Y_RES,      ; yres
...
qjetpfontGeometries     FontGeometry \
                <       FID_DTC_URW_ROMAN,
                        12,
                        offset qjetp_12ptpitchTab >
                word    FID_INVALID             ;table terminator


qjetp_12ptpitchTab      label   byte
        byte    TP_21_3_PITCH
        byte    TP_12_PITCH
        byte    TP_10_6_PITCH
        byte    TP_10_PITCH
