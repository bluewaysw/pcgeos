...
REVISION HISTORY:
	...
	----	----		-----------
	Dave	6/95		Initial revision from inter1Info.asm

DESCRIPTION:
	This file contains the device information for the HP deskjet
	Other Printers Supported by this resource:

	$Id: deskjetJEDIInfo.asm,v 1.1 97/04/18 11:51:53 newdeal Exp $
...
deskjetJEDIInfo	segment	resource
...
PrinterInfo		 <		; ---- PrinterType -------------
				...
				NULL,		
					; ---- Mode Info Offsets -------
				offset deskjetJEDIlowRes,
				offset deskjetJEDImedRes,
				offset deskjetJEDIhiRes,
				NULL,	
				offset deskjetJEDInlq,
                                        ; ---- Font Geometry -----------
                                NULL,
                                        ; ---- Symbol Set list -----------
                                offset deskjetJEDISymbolSets,
					; ---- PaperMargins ------------
...
deskjetJEDIlowRes  GraphicsProperties < LO_RES_X_RES,      ; xres
                                     LO_RES_Y_RES,      ; yres
...
deskjetJEDImedRes  GraphicsProperties < MED_RES_X_RES,     ; xres
                                     MED_RES_Y_RES,     ; yres
...
deskjetJEDIhiRes   GraphicsProperties < HI_RES_X_RES,      ; xres
                                     HI_RES_Y_RES,      ; yres
...
deskjetJEDISymbolSets label   word
...
deskjetJEDInlq	label	word

deskjetJEDIInfo	ends
