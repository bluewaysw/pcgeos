...
DESCRIPTION:
	...
	$Id: deskjetjManager.asm,v 1.1 97/04/18 11:51:53 newdeal Exp $
...
include Job/Custom/customNoPCLReset.asm ;JEDI entry for no reset.
...
include	deskjetjDriverInfo.asm		; overall driver info

include	deskjetJEDIInfo.asm

include	Color/Correct/correctGamma175.asm
