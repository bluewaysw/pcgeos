...
PROJECT:	PC GEOS
MODULE:		Deskjet KCMY Print Driver
FILE:		mercuryControlCodes.asm
...
DC_ESCRIPTION:
	...
	$Id: mercuryControlCodes.asm,v 1.1 97/04/18 11:52:31 newdeal Exp $
...
pr_codes_InitPrinter	label	byte
	...
	byte	C_ESC,"*r-4U"		;use 4 plane KCMY pallette.
