...
FILE:		cursorSetCursorTab72ASCII.asm
...
DESCRIPTION:
	...
	$Id: cursorSetCursorTab72ASCII.asm,v 1.1 97/04/18 11:49:44 newdeal Exp $
...
SYNOPSIS:	
	...
	NOTE: this routine differs from that in cursorSetCursorTab72.asm only
	in that the tab stop position is sent as a three digit ASCII number.
...
PASS:
	...
	PState MUST have a font initialized for this to work.
...
PSEUDO CODE/STRATEGY:
	...
	2 save current style word, and set to no styles
	3 do X positioning
	4 recover and set the previous styles
...
storeNewXPosition:	
	...
	mov	dx,12
	call	PrintSetFont
	pop	ax			;get the character position.
	jc	exit
	mov	si, offset pr_codes_SetTab
	call	SendCodeOut
	jc	exit
	mov	cx,3			;send three digits.
