...
DESCRIPTION:
	...
	$Id: cursorPrLineFeedSet.asm,v 1.1 97/04/18 11:49:41 newdeal Exp $
...
PrLineFeed	proc	near
	...
	jb	doRem
	mov	si,offset pr_codes_SetMaxLineFeed ;code to Set max/360" feed.
...
doRem:
	...
	jz	exit		;if so, exit.
	mov	si,offset pr_codes_SetLineFeed ;code to Set n/360" feed.
	call	SendCodeOut	;send the code to the stream.
	jc	exit
