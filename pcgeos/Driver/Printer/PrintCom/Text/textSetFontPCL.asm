...
DESCRIPTION:
	This file contains most of the code to implement the PCL 3
	print driver ascii text support

	$Id: textSetFontPCL.asm,v 1.1 97/04/18 11:50:05 newdeal Exp $
...
loadTypeface:
	...
	mov	si,offset pr_codes_SetUnderline	;fix up underline.
	test	es:PS_asciiStyle,mask PTS_UNDERLINE
	jnz	underlineSet
