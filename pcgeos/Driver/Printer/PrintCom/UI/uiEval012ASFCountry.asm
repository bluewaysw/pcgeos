...
DESCRIPTION:
	...
	$Id: uiEval012ASFCountry.asm,v 1.1 97/04/18 11:50:35 newdeal Exp $
...
PrintEvalASF0Bin	proc	near
	...
	push	si
	mov	si,offset OptionsASF0BinResource:ASF0BinCountryList
	call	PrintEvalASFCommon
	pop	si
...
PrintEvalASF1BinOnly	proc	near
	...
	pop	si
        mov     es:[si].[JP_printerData].[PUID_paperInput],al
	push	si
	mov	si,offset OptionsASF1BinOnlyResource:ASF1BinOnlyCountryList
	call	PrintEvalASFCommon
	pop	si
        mov     es:[si].[JP_printerData].[PUID_countryCode],al
        mov     es:[si].[JP_printerData].[PUID_symbolSet],PSS_IBM437
...
PrintEvalASF2Bin	proc	near
	...
	pop	si
        mov     es:[si].[JP_printerData].[PUID_paperInput],al
	push	si
	mov	si,offset OptionsASF2BinResource:ASF2BinCountryList
	call	PrintEvalASFCommon
	pop	si
        mov     es:[si].[JP_printerData].[PUID_countryCode],al
        mov     es:[si].[JP_printerData].[PUID_symbolSet],PSS_IBM437
