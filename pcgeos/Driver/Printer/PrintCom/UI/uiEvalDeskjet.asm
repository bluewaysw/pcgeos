...
DESCRIPTION:
	...
	+tractor and manual feed print deskjet driver UI support

	$Id: uiEvalDeskjet.asm,v 1.1 97/04/18 11:50:42 newdeal Exp $
...
PrintEvalASF1Bin	proc	near
	...
	push	si
	mov	si,offset OptionsASF1BinResource:ASF1BinCompressionList
	call	PrintEvalASFCommon
	pop	si
        mov     es:[si].[JP_printerData].[PUID_compressionMode],al
	push	si
...
stuffUI:
        clr     ch
        mov     cl,es:[si].[JP_printerData].[PUID_compressionMode]
	push	si
	mov	si,offset OptionsASF1BinResource:ASF1BinCompressionList
...
PrintEvalASF2Bin	proc	near
	...
	mov	bx,dx		;handle of the options list tree.
	push	si
	mov	si,offset OptionsASF2BinResource:ASF2BinCompressionList
	call	PrintEvalASFCommon
	pop	si
        mov     es:[si].[JP_printerData].[PUID_compressionMode],al
	push	si
