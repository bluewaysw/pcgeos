...
AUTHOR:		owa, Mar/94. from Epson24/epson24DriverInfo.asm

	
REVISION HISTORY:
	Name	Date		Description
	----	----		-----------
	owa	Feb/94		Initial revision
...
DESCRIPTION:
	...
	$Id: epson24DriverInfo.asm,v 1.1 97/04/18 11:53:24 newdeal Exp $
...
DefPrinter PD_TOSHIBA_INKJET4, "Toshiba InkJet Printer(Epson Mode)", inkjetInfo
