...
pr_codes_SetPageMargins		label	byte
	byte	5		;byte count
	byte	C_ESC,"(p",8,0	;command = EXTENDED PAGE MARGIN SETTINGS, byte count
				;8 bytes = pl.hi/lo, lm.hi/lo, rm.hi/lo, offset.hi/lo
...
pr_codes_SetPrintMediaLoading	label	byte
	byte	5		;byte count
	byte	C_ESC,"(l",2,0	;command = SET PRINT MEDIA LOADING, byte count
