...
DESCRIPTION:
	...
	$Id: gemini9wInfo.asm,v 1.1 97/04/18 11:54:30 newdeal Exp $
...
geminiwlowRes	GraphicsProperties < LO_RES_X_RES,	; xres
				     LO_RES_Y_RES,	; yres
...
geminiwhiRes	GraphicsProperties < HI_RES_X_RES,	; xres
				     HI_RES_Y_RES,	; yres
...
geminiwfontGeometries     FontGeometry \
                <       FID_DTC_URW_ROMAN,
                        12,
                        offset geminiw_12ptpitchTab >
                word    FID_INVALID             ;table terminator


geminiw_12ptpitchTab      label   byte
        byte    TP_17_PITCH
        byte    TP_12_PITCH
        byte    TP_10_PITCH
        byte    TP_5_PITCH
