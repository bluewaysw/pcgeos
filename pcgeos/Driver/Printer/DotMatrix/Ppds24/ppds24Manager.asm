...
PROJECT:	PC GEOS
MODULE:		IBM late model 24-pin printer driver
FILE:		ppds24Manager.asm
...
DESCRIPTION:
	...
	$Id: ppds24Manager.asm,v 1.1 97/04/18 11:54:25 newdeal Exp $
...
include	ppds24DriverInfo.asm		; overall driver info
