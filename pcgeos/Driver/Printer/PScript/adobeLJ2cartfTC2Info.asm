...
DESCRIPTION:
	...
	$Id: adobeLJ2cartfTC2Info.asm,v 1.1 97/04/18 11:56:15 newdeal Exp $

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%@

;----------------------------------------------------------------------------
;	Adobe LaserJet 2 Cartridge with Extra Font Cart 2
;----------------------------------------------------------------------------

adobeLJ2fTC2Info	segment	resource
	...
	; info blocks
		...
		PrinterInfo <		; ---- PrinterType -------------
				...
				NULL,
				NULL,
			        offset adobeLJ2fTC2hiRes, ; PM_GRAPHICS_HI_RES
				NULL,	
				NULL,
                                        ; ---- Font Geometry -----------
                                NULL,
...
adobeLJ2fTC2hiRes  GraphicsProperties < 300,		; xres
				 	300,		; yres
				 	1,  		; band height
				 	1, 		; buff height
				 	1, 		; interleaves
...
;	*must* be placed directly after the hires GraphicProperties struct
		...
		PSInfoStruct   <
			      PSFL_ADOBE_TC2,	; PSFontList
			      0x0001,		; PSLevel flags 
			      ALJ2C2_PROLOG_LEN,	; prolog length
			      offset adobeLJ2fTC2Prolog ; ptr to prolog
...
adobeLJ2fTC2Prolog	label	byte
	...
	char	"end", NL
adobeLJ2fTC2EndProlog	label	byte

ALJ2C2_PROLOG_LEN equ	offset adobeLJ2fTC2EndProlog - offset adobeLJ2fTC2Prolog

adobeLJ2fTC2Info	ends
