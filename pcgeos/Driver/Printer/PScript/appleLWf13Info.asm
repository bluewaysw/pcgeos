...
DESCRIPTION:
	...
	$Id: appleLWf13Info.asm,v 1.1 97/04/18 11:56:20 newdeal Exp $

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%@


;----------------------------------------------------------------------------
;	LaserWriter Info (original 13 font laserwriter)
;----------------------------------------------------------------------------

appleLWf13Info	segment	resource
...
appleLWf13hiRes	   GraphicsProperties < 300,		; xres
					300,		; yres
					1,  		; band height
					1,  		; buff height
					1, 		; interleaves
...
;	*must* be placed directly after the hires GraphicProperties struct
		...
		PSInfoStruct   <
			      ...
			      LW_PROLOG_LEN,	; prolog length
			      offset appleLWf13Prolog ; ptr to prolog
...
appleLWf13Prolog	label	byte
	...
	char	"end", NL
appleLWf13EndProlog	label	byte

LW_PROLOG_LEN equ	offset appleLWf13EndProlog - offset appleLWf13Prolog
