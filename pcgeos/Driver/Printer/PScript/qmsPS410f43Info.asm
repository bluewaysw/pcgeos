...
DESCRIPTION:
	...
	$Id: qmsPS410f43Info.asm,v 1.1 97/04/18 11:56:14 newdeal Exp $
...
qmsPS410f43Info	segment	resource
	...
	; info blocks
		...
		PrinterInfo <		; ---- PrinterType -------------
				...
				NULL,
				NULL,
			      	offset qmsPS410f43hiRes,; PM_GRAPHICS_HI_RES
				NULL,	
				NULL,
                                        ; ---- Font Geometry -----------
                                NULL,
...
qmsPS410f43hiRes   GraphicsProperties < 300,		; xres
					300,		; yres
					1,  		; band height
					1,  		; buff height
					1, 		; interleaves
...
;	*must* be placed directly after the hires GraphicProperties struct
		...
		PSInfoStruct   <
			      PSFL_QMS_43,	; PSFontList
			      0x0001,		; PSLevel flags 
			      QMS43_PROLOG_LEN,	; prolog length
			      offset qmsPS410f43Prolog ; ptr to prolog
...
qmsPS410f43Prolog	label	byte
	...
	char	"end", NL
qmsPS410f43EndProlog	label	byte

QMS43_PROLOG_LEN equ	offset qmsPS410f43EndProlog - offset qmsPS410f43Prolog

qmsPS410f43Info	ends
