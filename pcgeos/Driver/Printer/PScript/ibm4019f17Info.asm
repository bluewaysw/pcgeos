...
DESCRIPTION:
	...
	$Id: ibm4019f17Info.asm,v 1.1 97/04/18 11:56:18 newdeal Exp $
...
ibm4019f17Info	segment	resource
...
ibm4019f17hiRes    GraphicsProperties < 300,		; xres
					300,		; yres
					1,  		; band height
					1,  		; buff height
					1, 		; interleaves
...
;	*must* be placed directly after the hires GraphicProperties struct
		...
		PSInfoStruct   <
			      ...
			      IBM17_PROLOG_LEN,	; prolog length
			      offset ibm4019f17Prolog ; ptr to prolog
...
ibm4019f17Prolog	label	byte
	...
	char	"end", NL
ibm4019f17EndProlog	label	byte

IBM17_PROLOG_LEN equ	offset ibm4019f17EndProlog - offset ibm4019f17Prolog
