...
REVISION HISTORY:
	...
	----	----		-----------
	Tera	11/16/93	Initial revision

DESCRIPTION:
	Manager file for keyboard driver

	$Id: keyboard.asm,v 1.1 97/04/18 11:47:46 newdeal Exp $
...
LocalDefString kbdStr <"Toshiba 101US Keyboard",0>
