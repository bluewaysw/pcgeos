chooseUI.rdef: generic.uih product.uih
chooseUI.obj \
chooseUI.eobj: geos.def geode.def resource.def ec.def library.def \
                object.def lmem.def graphics.def fontID.def font.def \
                color.def win.def timer.def Objects/processC.def \
                Objects/metaC.def chunkarr.def geoworks.def localize.def \
                sllang.def ui.def file.def vm.def text.def char.def \
                input.def hwr.def gcnlist.def timedate.def \
