...
spotlightpref.rdef: generic.uih config.uih Objects/colorC.uih saver.uih
spotlightpref.eobj \
spotlightpref.obj: ../spotlight.def Internal/gUtils.def Internal/uProcC.def\
                  ...
                  Objects/visC.def alb.def char.def chunkarr.def color.def\
                  config.def disk.def drive.def ec.def file.def font.def\
                  fontID.def gcnlist.def geode.def geos.def geoworks.def\
                  graphics.def gstring.def heap.def hwr.def iacp.def\
                  input.def library.def lmem.def localize.def object.def\
                  resource.def saver.def sllang.def spotlightpref.asm\
                  stylesh.def text.def token.def uDialog.def ui.def vm.def\
                  win.def
spotlightpref.eobj \
spotlightpref.obj:  spotlightpref.rdef
spotlightprefec.geo spotlightpref.geo: geos.ldf ui.ldf config.ldf
