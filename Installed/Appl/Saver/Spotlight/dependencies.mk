spotlight.rdef: generic.uih product.uih saver.uih
spotlight.obj \
spotlight.eobj: stdapp.def geos.def geode.def resource.def ec.def lmem.def \
                ...
                timer.def initfile.def hugearr.def Internal/im.def \
                Internal/semInt.def saver.def spotlight.def \
                spotlight.rdef

spotlightEC.geo spotlight.geo : saver.ldf ui.ldf geos.ldf 