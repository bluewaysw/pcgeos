letter.rdef: generic.uih product.uih saver.uih
letter.obj \
letter.eobj: stdapp.def geos.def geode.def resource.def ec.def lmem.def \
                ...
                timer.def initfile.def saver.def Objects/vTextC.def \
                spool.def print.def Internal/prodFeatures.def hugearr.def \
                dbase.def Objects/Text/tCtrlC.def ruler.def \
                Objects/colorC.def Objects/styles.def letter.def \
                letter.rdef

letterEC.geo letter.geo : saver.ldf ui.ldf geos.ldf 