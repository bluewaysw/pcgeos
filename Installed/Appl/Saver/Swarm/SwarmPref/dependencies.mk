swarmpref.rdef: generic.uih product.uih config.uih Objects/colorC.uih \
                saver.uih
swarmpref.obj \
swarmpref.eobj: geos.def heap.def geode.def resource.def ec.def \
                ...
                config.def Objects/colorC.def saver.def ../swarm.def \
                swarmpref.rdef

swarmprefEC.geo swarmpref.geo : geos.ldf ui.ldf config.ldf 