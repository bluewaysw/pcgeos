swarm.rdef: generic.uih product.uih saver.uih
swarm.obj \
swarm.eobj: stdapp.def geos.def geode.def resource.def ec.def lmem.def \
                ...
                timer.def initfile.def saver.def swarm.def swarm.rdef

swarmEC.geo swarm.geo : saver.ldf ui.ldf geos.ldf 