dribble.rdef: generic.uih product.uih saver.uih
dribble.obj \
dribble.eobj: stdapp.def geos.def geode.def resource.def ec.def lmem.def \
                ...
                timer.def initfile.def saver.def dribble.def dribble.rdef \
                Art/mkrBlue.ui Art/mkrRed.ui Art/mkrViolet.ui \
                Art/mkrGreen.ui Art/mkrYellow.ui

dribbleEC.geo dribble.geo : saver.ldf ui.ldf geos.ldf 