pieces.rdef: generic.uih product.uih saver.uih
pieces.obj \
pieces.eobj: stdapp.def geos.def geode.def resource.def ec.def lmem.def \
                ...
                timer.def initfile.def saver.def pieces.def pieces.rdef

piecesEC.geo pieces.geo : saver.ldf ui.ldf geos.ldf 