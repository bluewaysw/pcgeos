piecespref.rdef: generic.uih product.uih config.uih Objects/colorC.uih \
                saver.uih
piecespref.obj \
piecespref.eobj: geos.def heap.def geode.def resource.def ec.def \
                ...
                config.def Objects/colorC.def saver.def ../pieces.def \
                piecespref.rdef

piecesprefEC.geo piecespref.geo : geos.ldf ui.ldf config.ldf 