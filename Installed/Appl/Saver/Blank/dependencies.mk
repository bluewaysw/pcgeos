blank.rdef: generic.uih product.uih saver.uih
blank.obj \
blank.eobj: stdapp.def geos.def geode.def resource.def ec.def lmem.def \
                ...
                saver.def blank.rdef

blankEC.geo blank.geo : saver.ldf ui.ldf geos.ldf 