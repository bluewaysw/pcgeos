palette.rdef: generic.uih product.uih saver.uih
palette.obj \
palette.eobj: stdapp.def geos.def geode.def resource.def ec.def lmem.def \
                ...
                timer.def initfile.def saver.def Internal/videoDr.def \
                driver.def hugearr.def palette.def palette.rdef

paletteEC.geo palette.geo : saver.ldf ui.ldf geos.ldf 