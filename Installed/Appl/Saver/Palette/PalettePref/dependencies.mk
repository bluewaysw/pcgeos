palettepref.rdef: generic.uih product.uih config.uih Objects/colorC.uih \
                saver.uih
palettepref.obj \
palettepref.eobj: geos.def heap.def geode.def resource.def ec.def \
                ...
                config.def Objects/colorC.def saver.def ../palette.def \
                palettepref.rdef

paletteprefEC.geo palettepref.geo : geos.ldf ui.ldf config.ldf 