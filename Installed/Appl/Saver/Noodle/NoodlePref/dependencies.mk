noodlepref.rdef: generic.uih product.uih config.uih Objects/colorC.uih \
                saver.uih
noodlepref.obj \
noodlepref.eobj: geos.def heap.def geode.def resource.def ec.def \
                ...
                config.def Objects/colorC.def saver.def ../noodle.def \
                noodlepref.rdef

noodleprefEC.geo noodlepref.geo : geos.ldf ui.ldf config.ldf 