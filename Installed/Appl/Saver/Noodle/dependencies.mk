noodle.rdef: generic.uih product.uih saver.uih
noodle.obj \
noodle.eobj: stdapp.def geos.def geode.def resource.def ec.def lmem.def \
                ...
                timer.def initfile.def saver.def noodle.def noodle.rdef

noodleEC.geo noodle.geo : saver.ldf ui.ldf geos.ldf 