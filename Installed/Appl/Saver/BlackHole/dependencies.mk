blackhole.rdef: generic.uih product.uih saver.uih
blackhole.obj \
blackhole.eobj: stdapp.def geos.def geode.def resource.def ec.def lmem.def \
                ...
                timer.def initfile.def saver.def blackhole.def \
                blackhole.rdef

blackholeEC.geo blackhole.geo : saver.ldf ui.ldf geos.ldf 