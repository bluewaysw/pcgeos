blackholepref.rdef: generic.uih product.uih config.uih Objects/colorC.uih \
                saver.uih
blackholepref.obj \
blackholepref.eobj: geos.def heap.def geode.def resource.def ec.def \
                ...
                config.def Objects/colorC.def saver.def ../blackhole.def \
                blackholepref.rdef

blackholeprefEC.geo blackholepref.geo : geos.ldf ui.ldf config.ldf 