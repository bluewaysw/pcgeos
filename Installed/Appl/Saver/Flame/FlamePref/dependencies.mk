flamepref.rdef: generic.uih product.uih config.uih Objects/colorC.uih \
                saver.uih
flamepref.obj \
flamepref.eobj: geos.def heap.def geode.def resource.def ec.def \
                ...
                config.def Objects/colorC.def saver.def ../flame.def \
                flamepref.rdef

flameprefEC.geo flamepref.geo : geos.ldf ui.ldf config.ldf 