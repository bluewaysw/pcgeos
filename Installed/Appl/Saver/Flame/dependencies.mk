flame.rdef: generic.uih product.uih saver.uih
flame.obj \
flame.eobj: stdapp.def geos.def geode.def resource.def ec.def lmem.def \
                ...
                flame.def flame.rdef

flameEC.geo flame.geo : saver.ldf ui.ldf geos.ldf 