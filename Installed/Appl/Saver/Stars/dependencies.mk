stars.rdef: generic.uih product.uih saver.uih
stars.obj \
stars.eobj: stdapp.def geos.def geode.def resource.def ec.def lmem.def \
                ...
                timer.def initfile.def saver.def stars.def stars.rdef

starsEC.geo stars.geo : saver.ldf ui.ldf geos.ldf 