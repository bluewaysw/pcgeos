wormspref.rdef: generic.uih product.uih config.uih Objects/colorC.uih \
                saver.uih
wormspref.obj \
wormspref.eobj: geos.def heap.def geode.def resource.def ec.def \
                ...
                config.def Objects/colorC.def saver.def ../worms.def \
                wormspref.rdef

wormsprefEC.geo wormspref.geo : geos.ldf ui.ldf config.ldf 