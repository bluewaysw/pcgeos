tiles.rdef: generic.uih product.uih saver.uih
tiles.obj \
tiles.eobj: stdapp.def geos.def geode.def resource.def ec.def lmem.def \
                ...
                timer.def initfile.def saver.def tiles.def tiles.rdef

tilesEC.geo tiles.geo : saver.ldf ui.ldf geos.ldf 