tilespref.rdef: generic.uih product.uih config.uih Objects/colorC.uih \
                saver.uih
tilespref.obj \
tilespref.eobj: geos.def heap.def geode.def resource.def ec.def \
                ...
                config.def Objects/colorC.def saver.def ../tiles.def \
                tilespref.rdef

tilesprefEC.geo tilespref.geo : geos.ldf ui.ldf config.ldf 