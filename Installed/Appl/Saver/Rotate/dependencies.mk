rotate.rdef: generic.uih product.uih saver.uih
rotate.obj \
rotate.eobj: stdapp.def geos.def geode.def resource.def ec.def lmem.def \
                ...
                timer.def initfile.def backgrnd.def saver.def rotate.def \
                rotate.rdef

rotateEC.geo rotate.geo : saver.ldf ui.ldf geos.ldf 