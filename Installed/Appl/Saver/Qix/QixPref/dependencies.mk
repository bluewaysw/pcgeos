qixpref.rdef: generic.uih product.uih config.uih Objects/colorC.uih \
                saver.uih
qixpref.obj \
qixpref.eobj: geos.def heap.def geode.def resource.def ec.def \
                ...
                config.def Objects/colorC.def saver.def ../qix.def \
                qixpref.rdef

qixprefEC.geo qixpref.geo : geos.ldf ui.ldf config.ldf 