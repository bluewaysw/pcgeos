qix.rdef: generic.uih product.uih saver.uih
qix.obj \
qix.eobj: stdapp.def geos.def geode.def resource.def ec.def lmem.def \
                ...
                timer.def initfile.def saver.def qix.def qix.rdef

qixEC.geo qix.geo : saver.ldf ui.ldf geos.ldf 