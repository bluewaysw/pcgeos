sand.rdef: generic.uih product.uih saver.uih
sand.obj \
sand.eobj: stdapp.def geos.def geode.def resource.def ec.def lmem.def \
                ...
                library.def timer.def initfile.def saver.def sand.def \
                sand.rdef

sandEC.geo sand.geo : saver.ldf ui.ldf geos.ldf 