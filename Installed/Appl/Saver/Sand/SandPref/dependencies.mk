sandpref.rdef: generic.uih product.uih config.uih Objects/colorC.uih \
                saver.uih
sandpref.obj \
sandpref.eobj: geos.def heap.def geode.def resource.def ec.def \
                ...
                config.def Objects/colorC.def saver.def ../sand.def \
                sandpref.rdef

sandprefEC.geo sandpref.geo : geos.ldf ui.ldf config.ldf 