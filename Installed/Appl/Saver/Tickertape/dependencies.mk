tickertape.rdef: generic.uih product.uih saver.uih
tickertape.obj \
tickertape.eobj: stdapp.def geos.def geode.def resource.def ec.def lmem.def \
                ...
                timer.def initfile.def saver.def tickertape.def \
                tickertape.rdef

tickertapeEC.geo tickertape.geo : saver.ldf ui.ldf geos.ldf 