tickertapepref.rdef: generic.uih product.uih config.uih Objects/colorC.uih \
                saver.uih
tickertapepref.obj \
tickertapepref.eobj: geos.def heap.def geode.def resource.def ec.def \
                ...
                config.def Objects/colorC.def saver.def ../tickertape.def \
                tickertapepref.rdef

ttprefEC.geo ttpref.geo : geos.ldf ui.ldf config.ldf 