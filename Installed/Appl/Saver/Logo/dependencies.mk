logo.rdef: generic.uih product.uih saver.uih
logo.obj \
logo.eobj: stdapp.def geos.def geode.def resource.def ec.def lmem.def \
                ...
                timer.def initfile.def saver.def logo.rdef

logo.geo : ui.ldf saver.ldf 