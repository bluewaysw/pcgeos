hopalongpref.rdef: generic.uih product.uih config.uih Objects/colorC.uih \
                saver.uih
hopalongpref.obj \
hopalongpref.eobj: geos.def heap.def geode.def resource.def ec.def \
                ...
                config.def Objects/colorC.def saver.def ../hopalong.def \
                hopalongpref.rdef

hopalongprefEC.geo hopalongpref.geo : geos.ldf ui.ldf config.ldf 