hopalong.rdef: generic.uih product.uih saver.uih
hopalong.obj \
hopalong.eobj: stdapp.def geos.def geode.def resource.def ec.def lmem.def \
                ...
                timer.def initfile.def saver.def math.def hopalong.def \
                hopalong.rdef

hopalongEC.geo hopalong.geo : saver.ldf ui.ldf geos.ldf math.ldf 