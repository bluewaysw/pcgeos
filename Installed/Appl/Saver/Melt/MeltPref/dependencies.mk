meltpref.rdef: generic.uih product.uih config.uih Objects/colorC.uih \
                saver.uih
meltpref.obj \
meltpref.eobj: geos.def heap.def geode.def resource.def ec.def \
                ...
                config.def Objects/colorC.def saver.def ../melt.def \
                meltpref.rdef

meltprefEC.geo meltpref.geo : geos.ldf ui.ldf config.ldf 