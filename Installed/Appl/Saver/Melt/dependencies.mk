melt.rdef: generic.uih product.uih saver.uih
melt.obj \
melt.eobj: stdapp.def geos.def geode.def resource.def ec.def lmem.def \
                ...
                timer.def initfile.def saver.def melt.def melt.rdef

meltEC.geo melt.geo : saver.ldf ui.ldf geos.ldf 