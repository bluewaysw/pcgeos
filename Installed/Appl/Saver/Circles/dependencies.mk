circles.rdef: generic.uih product.uih saver.uih
circles.obj \
circles.eobj: stdapp.def geos.def geode.def resource.def ec.def lmem.def \
                ...
                timer.def initfile.def saver.def circles.def circles.rdef

circlesEC.geo circles.geo : saver.ldf ui.ldf geos.ldf 