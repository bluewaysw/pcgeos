string.rdef: generic.uih product.uih saver.uih
string.obj \
string.eobj: stdapp.def geos.def geode.def resource.def ec.def lmem.def \
                ...
                timer.def initfile.def Internal/threadIn.def saver.def \
                string.def string.rdef

stringEC.geo string.geo : saver.ldf ui.ldf geos.ldf 