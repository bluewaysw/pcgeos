stringpref.rdef: generic.uih product.uih config.uih Objects/colorC.uih \
                saver.uih
stringpref.obj \
stringpref.eobj: geos.def heap.def geode.def resource.def ec.def \
                ...
                config.def Objects/colorC.def saver.def ../string.def \
                stringpref.rdef

stringprefEC.geo stringpref.geo : geos.ldf ui.ldf config.ldf 