pith.rdef: generic.uih product.uih saver.uih
pith.obj \
pith.eobj: stdapp.def geos.def geode.def resource.def ec.def lmem.def \
                ...
                dbase.def pith.def pithMessage.asm pith.rdef

pith.geo : saver.ldf ui.ldf geos.ldf text.ldf 