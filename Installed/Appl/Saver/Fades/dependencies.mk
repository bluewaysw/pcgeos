fades.rdef: generic.uih product.uih saver.uih
fades.obj \
fades.eobj: stdapp.def geos.def geode.def resource.def ec.def lmem.def \
                ...
                timer.def initfile.def saver.def fades.def fades.rdef

fadesEC.geo fades.geo : saver.ldf ui.ldf geos.ldf 