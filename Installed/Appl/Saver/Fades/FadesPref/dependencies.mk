fadespref.rdef: generic.uih product.uih config.uih Objects/colorC.uih \
                saver.uih
fadespref.obj \
fadespref.eobj: geos.def heap.def geode.def resource.def ec.def \
                ...
                config.def Objects/colorC.def saver.def ../fades.def \
                fadespref.rdef

fadesprefEC.geo fadespref.geo : geos.ldf ui.ldf config.ldf 