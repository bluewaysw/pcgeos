dust.rdef: generic.uih product.uih saver.uih
dust.obj \
dust.eobj: stdapp.def geos.def geode.def resource.def ec.def lmem.def \
                ...
                timer.def initfile.def saver.def dust.def dust.rdef

dustEC.geo dust.geo : saver.ldf ui.ldf geos.ldf 