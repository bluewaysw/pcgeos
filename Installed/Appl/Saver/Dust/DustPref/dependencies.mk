dustpref.rdef: generic.uih product.uih config.uih Objects/colorC.uih \
                saver.uih
dustpref.obj \
dustpref.eobj: geos.def heap.def geode.def resource.def ec.def \
                ...
                config.def Objects/colorC.def saver.def ../dust.def \
                dustpref.rdef

dustprefEC.geo dustpref.geo : geos.ldf ui.ldf config.ldf 