bobbinpref.rdef: generic.uih product.uih config.uih Objects/colorC.uih \
                saver.uih
bobbinpref.obj \
bobbinpref.eobj: geos.def heap.def geode.def resource.def ec.def \
                ...
                config.def Objects/colorC.def saver.def ../bobbin.def \
                bobbinpref.rdef

bobbinprefEC.geo bobbinpref.geo : geos.ldf ui.ldf config.ldf 