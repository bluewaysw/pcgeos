mazepref.rdef: generic.uih product.uih config.uih Objects/colorC.uih \
                saver.uih
mazepref.obj \
mazepref.eobj: geos.def heap.def geode.def resource.def ec.def \
                ...
                config.def Objects/colorC.def saver.def ../maze.def \
                mazepref.rdef

mazeprefEC.geo mazepref.geo : geos.ldf ui.ldf config.ldf 