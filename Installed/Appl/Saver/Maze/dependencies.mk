maze.rdef: generic.uih product.uih saver.uih
maze.obj \
maze.eobj: stdapp.def geos.def geode.def resource.def ec.def lmem.def \
                ...
                timer.def Objects/winC.def saver.def maze.def maze.rdef \
                mzsolve.asm mazeScreenSave.asm

mazeEC.geo maze.geo : saver.ldf geos.ldf ui.ldf 