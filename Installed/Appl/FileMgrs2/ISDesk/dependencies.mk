...
cuiMain.rdef    : generic.uih shell.uih cuiNewDesk.uih Objects/eMenuC.uih\
                  CArt/cbmFiveInchDisk.ui CArt/cbmThreeInchDisk.ui\
                  cuiDisk.ui cuiFileOper.ui cuiMisc.ui cuiGetInfo.ui\
                  cuiMonikers.ui CArt/cmkrGenDoc.ui CArt/cmkrGenAppl.ui\
                  CArt/cartNDMonikerLists.ui CArt/cmkrNDHelp.ui\
                  CArt/cmkrNDWasteBasket.ui CArt/cmkrNDFileFolder.ui\
                  CArt/cmkrNDDosAppl.ui CArt/cmkrNDDosData.ui\
                  CArt/cmkrNDPrinter.ui CArt/cmkrNDCDRom.ui\
                  CArt/cmkrNDThreeInchDisk.ui CArt/cmkrNDFiveInchDisk.ui\
                  CArt/cmkrNDTemplate.ui CArt/cmkrNDHardDrive.ui\
                  CArt/cmkrNDRamDisk.ui CArt/cmkrNDNetDrive.ui cuiStrings.ui\
                  cuiNDGlobalMenu.ui cuiNDFolderTemplate.ui\
                  cuiNDDesktopFolderTemplate.ui cuiNDPrinter.ui\
                  cuiNDWastebasketTemplate.ui cuiNDDriveTemplate.ui\
                  cuiNDNonOpenableTemplate.ui
...
Util.obj        : CFolder/cfolderConstant.def Internal/dos.def\
                  ...
                  cutilEC.asm cutilError.asm cutilFileOpHigh.asm\
                  cutilFileOpLow.asm cutilFileOpMiddle.asm cutilManager.asm\
                  cutilSpecialObj.asm cutilUtil.asm cutilVariable.def\
                  ...
                  heap.def hugearr.def hwr.def iacp.def initfile.def\
                  input.def lmem.def localize.def net.def netware.def\
                  object.def print.def resource.def shell.def sllang.def\
                  spool.def stdapp.def stylesh.def sysstats.def text.def\
                  timer.def token.def uDialog.def ui.def vm.def win.def\
                  newdesk.def
Folder.eobj \
Folder.obj      : Internal/diskInt.def Internal/dos.def\
                  Internal/driveInt.def Internal/fileInt.def\
                  Internal/fsd.def Internal/gUtils.def Internal/heapInt.def\
                  Internal/im.def Internal/netDr.def Internal/parallDr.def\
                  Internal/prodFeatures.def Internal/semInt.def\
                  Internal/serialDr.def Internal/socketID.def\
                  ...
                  cfolderManager.asm cfolderMisc.asm \
                  ...
                  cfolderVariable.def char.def chunkarr.def color.def\
                  copenfileClass.def cnddesktopfolderClass.asm\
                  cndfolderClass.asm cndfolderDriveClass.asm\
                  cndfolderIcon.asm cndfolderPopupMenu.asm\
                  cndfolderWastebasket.asm dbase.def disk.def drive.def\
                  ...
                  ui.def vm.def win.def newdesk.def
DeskDisplay.eobj \
DeskDisplay.obj : Internal/gUtils.def Internal/grWinInt.def Internal/im.def\
                  ...
                  cdeskdisplayVariable.def cdesktopConstant.def\
                  cdesktopGeode.def cdesktopGlobal.def cdesktopMacro.def\
                  char.def chunkarr.def color.def copenfileClass.def\
                  dbase.def disk.def drive.def driver.def ec.def file.def\
                  ...
                  stdapp.def stylesh.def system.def text.def timer.def\
                  token.def uDialog.def ui.def vm.def win.def newdesk.def
DeskVis.eobj \
DeskVis.obj     : Internal/gUtils.def Internal/im.def Internal/netDr.def\
                  ...
                  chunkarr.def color.def copenfileClass.def dbase.def\
                  disk.def drive.def driver.def ec.def file.def fmtool.def\
                  font.def fontID.def gcnlist.def geode.def geos.def\
                  geoworks.def graphics.def gstring.def heap.def\
...
Main.obj        : Internal/diskInt.def Internal/dos.def\
                  Internal/driveInt.def Internal/fileInt.def\
                  Internal/fsd.def Internal/gUtils.def\
...
ShObj.obj       : Internal/gUtils.def Internal/im.def Internal/netDr.def\
                  ...
                  cshobjManager.asm cshobjMoveCopy.asm cshobjReceive.asm\
                  cshobjUtils.asm cshobjVariable.def dbase.def disk.def\
                  drive.def driver.def ec.def file.def fmtool.def font.def\
                  fontID.def gcnlist.def geode.def geos.def geoworks.def\
                  graphics.def gstring.def heap.def hugearr.def hwr.def\
                  iacp.def input.def lmem.def localize.def net.def\
...
Tree.obj        : Internal/gUtils.def Internal/im.def Internal/netDr.def\
                  ...
                  newdesk.def
Tool.eobj \
Tool.obj        : Internal/gUtils.def Internal/im.def Internal/netDr.def\
                  Internal/prodFeatures.def Internal/semInt.def\
                  Internal/serialDr.def Internal/socketID.def\
                  Internal/streamDr.def Internal/uProcC.def\
                  Internal/vUtils.def Objects/Text/tCommon.def\
...
Bitmap.obj      : Internal/gUtils.def Internal/im.def Internal/netDr.def\
                  ...
                  cdesktopConstant.def cdesktopGeode.def cdesktopGlobal.def\
                  cdesktopMacro.def char.def chunkarr.def color.def\
                  copenfileClass.def dbase.def disk.def drive.def\
                  ...
                  token.def uDialog.def ui.def vm.def win.def newdesk.def
newdeskec.geo newdesk.geo: geos.ldf ui.ldf net.ldf shell.ldf wav.ldf
