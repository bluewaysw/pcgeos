pyramid.rdef: pyramid.ui generic.uih product.uih cards.uih Art/mkpyr.ui
pyramid.obj \
pyramid.eobj: stdapp.def geos.def geode.def resource.def ec.def lmem.def \
                ...
                initfile.def assert.def cards.def myMacros.def sizes.def \
                pyramid.def pyramid.rdef pyramidGame.asm pyramidDeck.asm

pyramidEC.geo pyramid.geo : geos.ldf ui.ldf cards.ldf 