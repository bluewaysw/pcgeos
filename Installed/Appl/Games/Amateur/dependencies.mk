amatuer.rdef:	amateur.ui

amateurMain.obj \
amateurMain.eobj: stdapp.def geos.def geode.def resource.def ec.def lmem.def \
                ...
                timer.def system.def Objects/inputC.def \
                Objects/vTextC.def spool.def print.def \
                Internal/prodFeatures.def hugearr.def dbase.def sound.def \
                driver.def Internal/soundFmt.def Internal/semInt.def \
                game.def amateurMacros.def amateurConstants.def \
                amateurObjects.def amateur.rdef circles.def \
                amateurCommon.asm amateurContent.asm amateurPellet.asm \
                amateurCloud.asm amateurClown.asm amateurProcess.asm \
                amateurPeanut.asm amateurTomato.asm amateurDisplay.asm \
                amateurRandom.asm amateurJoke.asm amateurBitmap.asm \
                amateurBlaster.asm amateurSound.asm amateurHiScore.asm
