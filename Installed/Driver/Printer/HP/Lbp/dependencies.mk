...
lbpManager.eobj \
lbpManager.obj  : Buffer/bufferClearOutput.asm Buffer/bufferCreate.asm\
                  ...
                  Cursor/cursorSetCursorCapsl.asm\
                  Graphics/graphicsAdjustForResolution.asm\
                  Graphics/graphicsCapslCommon.asm\
                  Graphics/graphicsCommon.asm\
                  Graphics/graphicsPrintSwath300.asm Internal/fontDr.def\
                  ...
                  Internal/window.def Job/jobCopiesCapsl.asm\
                  Job/jobEndDummy.asm Job/jobPaperCapsl.asm\
                  Job/jobPaperInfo.asm Job/jobStartCapsl.asm\
                  ...
                  Page/pageStartASFOnly.asm Stream/streamHexToASCII.asm\
                  Stream/streamSendCodeOut.asm Stream/streamWrite.asm\
                  Stream/streamWriteByte.asm Styles/stylesGet.asm\
                  Styles/stylesSRBold.asm Styles/stylesSRDblWidth.asm\
                  Styles/stylesSRItalic.asm Styles/stylesSROutline.asm\
                  Styles/stylesSRReverse.asm Styles/stylesSRShadow.asm\
                  Styles/stylesSRUnderline.asm Styles/stylesSet.asm\
                  Styles/stylesTest.asm Text/Font/fontCapslInfo.asm\
                  ...
                  Text/textSetFontCapsl.asm Text/textSetLineSpacing.asm\
                  Text/textSetSymbolSet.asm UI/uiEval.asm\
                  UI/uiEvalCapsl.asm UI/uiGetNoMain.asm UI/uiGetOptions.asm\
                  alb.def capsl2Info.asm capsl3Info.asm char.def\
                  ...
                  hugearr.def hwr.def iacp.def input.def lbpConstant.def\
                  lbpControlCodes.asm lbpDriverInfo.asm lbpManager.asm\
                  lmem.def localize.def object.def print.def\
                  printcomASFOnlyPage.asm printcomAdmin.asm\
                  printcomCapslCursor.asm printcomCapslDialog.asm\
                  printcomCapslGraphics.asm printcomCapslJob.asm\
                  printcomCapslStyles.asm printcomCapslText.asm\
                  printcomConstant.def printcomDotMatrixBuffer.asm\
                  printcomEntry.asm printcomHexStream.asm\
...
lbpManager.eobj \
lbpManager.obj:  printcomCapsl.rdef
lbpec.geo lbp.geo: geos.ldf ui.ldf spool.ldf
