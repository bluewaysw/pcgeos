bnf.rdef: generic.uih product.uih \
                /home/konstantinmeyer/github/pcgeos/Driver/Task/Common/task.ui
bnfManager.obj \
bnfManager.eobj: taskGeode.def geos.def heap.def geode.def resource.def \
                ...
                taskVariable.def bnfConstant.def bnfVariable.def bnf.rdef \
                taskStrings.asm bnfStrings.asm taskInit.asm \
                bnfInitExit.asm taskSwitch.asm taskApplication.asm \
                bnfApplication.asm taskDriver.asm bnfDriver.asm \
                taskTrigger.asm taskItem.asm bnfItem.asm taskUtils.asm \
                bnfUtils.asm bnfMain.asm bnfSummons.asm taskClipboard.asm \
                bnfClipboard.asm

bnfEC.geo bnf.geo : ui.ldf geos.ldf text.ldf 