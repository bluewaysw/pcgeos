inkfix.obj \
inkfix.eobj: geos.def heap.def geode.def resource.def library.def \
                ...
                chunkarr.def geoworks.def Objects/winC.def win.def ui.def \
                file.def input.def hwr.def localize.def sllang.def \
                ...
                pen.def Objects/inkfix.def

inkfixEC.geo inkfix.geo : geos.ldf ui.ldf pen.ldf 