prefbg.rdef: generic.uih product.uih config.uih Objects/colorC.uih \
                Art/mkrPrefBG.ui
prefbg.obj \
prefbg.eobj: stdapp.def geos.def geode.def resource.def ec.def lmem.def \
                ...
                library.def initfile.def backgrnd.def system.def \
                thread.def config.def Objects/colorC.def \
                Objects/vTextC.def spool.def print.def \
                Internal/prodFeatures.def hugearr.def dbase.def \
                Internal/convert.def prefbg.def prefbgDialog.def \
                prefbgChooseList.def prefbg.rdef prefbgDialog.asm \
                prefbgChooseList.asm

prefbgEC.geo prefbg.geo : geos.ldf ui.ldf config.ldf color.ldf convert.ldf 