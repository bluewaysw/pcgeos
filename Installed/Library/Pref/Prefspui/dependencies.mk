...
prefspui.rdef   : prefspui.uih generic.uih config.uih Objects/colorC.uih\
                  mkrPrefSpui.ui
prefspui.eobj \
prefspui.obj    : Internal/gUtils.def Internal/uProcC.def\
                  ...
                  drive.def ec.def file.def fileEnum.def font.def\
                  ...
                  localize.def object.def prefspui.asm prefspui.def\
                  prefspuiDialog.asm prefspuiDynamicList.asm\
                  prefspuiMacro.def print.def psDescriptiveDL.asm\
                  resource.def sllang.def spool.def stylesh.def text.def\
                  token.def uDialog.def ui.def vm.def win.def
prefspui.eobj \
prefspui.obj:  prefspui.rdef
prefspuiec.geo prefspui.geo: geos.ldf ui.ldf config.ldf
