...
prefintl.rdef   : generic.uih config.uih Objects/colorC.uih\
                  Art/mkrPrefIntl.ui
prefintl.eobj \
prefintl.obj    : Internal/gUtils.def Internal/uProcC.def\
                  ...
                  chunkarr.def color.def config.def dbase.def disk.def\
                  drive.def ec.def file.def font.def fontID.def gcnlist.def\
                  ...
                  prefintl.asm prefintl.def prefintlCustomSpin.asm\
                  prefintlCustomSpin.def prefintlDialog.asm\
                  prefintlDialog.def print.def resource.def sllang.def\
                  spool.def stylesh.def text.def token.def uDialog.def\
                  ui.def vm.def win.def
prefintl.eobj \
prefintl.obj:  prefintl.rdef
prefintlec.geo prefintl.geo: geos.ldf ui.ldf config.ldf
