preftd.rdef:	preftd.ui

preftd.obj \
preftd.eobj: geos.def heap.def geode.def resource.def ec.def \
                library.def object.def lmem.def graphics.def fontID.def \
                font.def color.def gstring.def text.def char.def win.def \
                initfile.def timer.def timedate.def localize.def \
                sllang.def ui.def file.def vm.def input.def hwr.def \
                ...
                config.def Objects/colorC.def preftdClockItem.def \
                preftd.rdef preftdClockItem.asm
