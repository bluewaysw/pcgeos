prefsock.rdef: generic.uih product.uih config.uih Objects/colorC.uih \
                Art/mkrPrefSocket.ui
prefsock.obj \
prefsock.eobj: geos.def heap.def geode.def resource.def ec.def \
                library.def object.def lmem.def graphics.def fontID.def \
                font.def color.def gstring.def text.def char.def win.def \
                initfile.def driver.def medium.def file.def ui.def vm.def \
                ...
                dbase.def socket.def Internal/serialDr.def \
                Internal/streamDr.def Internal/socketDr.def sockmisc.def \
                prefsock.def prefsock.rdef

prefsockEC.geo prefsock.geo : geos.ldf ui.ldf config.ldf 