prefpntc.rdef: generic.uih product.uih config.uih Objects/colorC.uih \
                parentc.uih Art/mkrpctrl.ui Art/mkrgreen.ui \
                Art/mkryellow.ui Art/mkrred.ui
prefpntc.obj \
prefpntc.eobj: geos.def heap.def geode.def resource.def ec.def \
                graphics.def fontID.def font.def color.def gstring.def \
                text.def char.def library.def ui.def file.def vm.def \
                win.def input.def hwr.def localize.def sllang.def \
                Objects/processC.def Objects/metaC.def object.def \
                lmem.def chunkarr.def geoworks.def gcnlist.def \
                ...
                config.def Objects/colorC.def parentc.def prefpntc.def \
                prefpntc.rdef

prefpntcEC.geo prefpntc.geo : geos.ldf ui.ldf config.ldf parentc.ldf 