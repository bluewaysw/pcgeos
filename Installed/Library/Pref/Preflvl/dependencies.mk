preflvl.rdef: generic.uih product.uih config.uih Objects/colorC.uih \
                Art/mkrPreflvl.ui
preflvl.obj \
preflvl.eobj: geos.def heap.def geode.def resource.def ec.def \
                library.def object.def lmem.def graphics.def fontID.def \
                font.def color.def gstring.def text.def char.def \
                initfile.def ui.def file.def vm.def win.def input.def \
                ...
                config.def Objects/colorC.def preflvl.rdef

preflvlEC.geo preflvl.geo : geos.ldf ui.ldf config.ldf 