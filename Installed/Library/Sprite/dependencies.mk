sprite.rdef: generic.uih product.uih game.uih sprite.uih
manager.obj \
manager.eobj: stdapp.def geos.def geode.def resource.def ec.def lmem.def \
                ...
                game.def sprite.def Objects/inputC.def sprite.rdef \
                spriteMain.asm spriteContent.asm

spriteEC.geo sprite.geo : geos.ldf ui.ldf 