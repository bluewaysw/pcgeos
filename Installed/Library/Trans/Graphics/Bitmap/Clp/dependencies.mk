...
Lib.eobj: Lib/libManager.asm \
                clpGeode.def graphicsGeode.def geos.def geode.def \
                ...
                clp.def libExport.rdef libFormat.asm libMain.asm \
...
Export.eobj: Export/exportManager.asm \
                ...
                Internal/dib.def Internal/xlatLib.def \
                transCommonGlobal.def graphicsMacro.def clpGlobal.def \
                clp.def exportCommon.asm exportMain.asm
Import.obj \
...
clpEC.geo clp.geo : geos.ldf ui.ldf ansic.ldf math.ldf impex.ldf dib.ldf 