 ...
 THIS IS A DEMO VERSION - You will not be able to save any of your
 work.  You will not be able to use any other Geos version
 software with this demo, nor will any of this demo software
 work with another Geos software package.
 ...
 4. ENSEMBLE RUNNING UNDER WINDOWS NT, 2000, XP
   ...
   CONFIG.NT file in step 5 below.
    ...
    NOTE: Ensemble will run only in full screen mode, and you may 
	  ...
	  Ensemble may run in only 640x480 16 colors.
