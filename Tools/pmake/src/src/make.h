 ...
 *
 *	"$Id: make.h,v 1.7 96/06/24 15:06:16 tbradley Exp $ SPRITE (Berkeley)"
 */
...
/*
 *	this is supposed to be predefined by __BORLANDC__
 */
#if !defined(unix)
...
#include    <ctype.h>
#include    "lst.h"
#include    "../src/customs/cust-cfg.h"
...
typedef struct GNode {
    ...
    long             type;     	/* Its type (see the OP flags, below) */
    ...
    long             mtime;     	/* Its modification time */
    long       	    cmtime;    	/* The modification time of its youngest
				 * child */
...
#define OP_EMPTY_CMD	0x01000000  /* Target has empty command, so even though
				     * command list is empty, we pretend it's
				     * not */

#define OP_NO_CMDS(t) (!((t)->type & OP_EMPTY_CMD) && \
		       Lst_IsEmpty((t)->commands))
...
/* function prototypes for many functions */
#include "prototyp.h"
