...
#	
#
#	$Id: makefref.tcl,v 1.7.12.1 97/03/29 11:25:06 canavese Exp $
#
###############################################################################
...
[defcmd fref {target dir out} support.reference
{`fref routineName' prints out the routine header for a function. If no function
...
[defcmd makefref {patient {outfile /staff/pcgeos/frefs}} support.reference
{'makefref ' calls fref on ALL functions for a geode. First argument PATIENT is
...
patient have their headers extracted in the proper form in right shadow file}
{
    ...
    [stream write
{.ds LF "\fB\s+2GeoWorks Company Confidential
.ds RF \*(DY
.LP
.de Fs
.KS
