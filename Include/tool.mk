...
#
.PATH.h		: c:/progra~1/devstudio/vc/include
...
#
CLINKFLAGS	+=  $(CFLAGS_COMMON) -Fe$(.TARGET) $(XCFLAGS)
...
#
MAKETOOL	: .USE 
	$(CC) $(CLINKFLAGS) $(.LIBS) $(.LIBS:S,$,/$(.TARGET:H),g) $(.ALLSRC)
#endif
#if $(TYPE) != "library"
...
MAKELIB		: .USE .PRECIOUS
	link -lib -nologo -out:"$(.TARGET:S%/%\\%g)" $(win32OBJS:S%/%\\%g)
